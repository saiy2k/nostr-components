...
import './nostr-verify-identity/nostr-verify.ts';
...
import NostrVerifyIdentity from './nostr-verify-identity/nostr-verify.ts';
...
export { default as NostrVerifyIdentity } from './nostr-verify-identity/nostr-verify.ts';
