...
var y = (n, e, t) => Ie(n, typeof e != "symbol" ? e + "" : e, t), Ue = (n, e, t) => e.has(n) || Ae("Cannot " + t);
var Te = (n, e, t) => e.has(n) ? Ae("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(n) : e.set(n, t);
var ve = (n, e, t) => (Ue(n, e, "access private method"), t);
...
function requireMs() {
  ...
  function a(f) {
    if (f = String(f), !(f.length > 100)) {
      ...
      if (h) {
        var p = parseFloat(h[1]), b = (h[2] || "ms").toLowerCase();
        switch (b) {
          case "years":
          case "year":
          case "yrs":
  ...
  function c(f) {
    var h = Math.abs(f);
    return h >= r ? Math.round(f / r) + "d" : h >= t ? Math.round(f / t) + "h" : h >= e ? Math.round(f / e) + "m" : h >= n ? Math.round(f / n) + "s" : f + "ms";
  }
  function l(f) {
    var h = Math.abs(f);
    return h >= r ? u(f, h, r, "day") : h >= t ? u(f, h, t, "hour") : h >= e ? u(f, h, e, "minute") : h >= n ? u(f, h, n, "second") : f + " ms";
  }
  function u(f, h, p, b) {
    var E = h >= p * 1.5;
    return Math.round(f / p) + " " + b + (E ? "s" : "");
  }
  return ms;
}
function setup(n) {
  t.debug = t, t.default = t, t.coerce = l, t.disable = a, t.enable = s, t.enabled = c, t.humanize = requireMs(), t.destroy = u, Object.keys(n).forEach((f) => {
    t[f] = n[f];
  ...
  function t(f) {
    ...
    function g(...m) {
      if (!g.enabled)
        return;
      const w = g, $ = Number(/* @__PURE__ */ new Date()), B = $ - (h || $);
      w.diff = B, w.prev = h, w.curr = $, h = $, m[0] = t.coerce(m[0]), typeof m[0] != "string" && m.unshift("%O");
      let P = 0;
      m[0] = m[0].replace(/%([a-zA-Z%])/g, (C, S) => {
        if (C === "%%")
          return "%";
        P++;
        const L = t.formatters[S];
        if (typeof L == "function") {
          const F = m[P];
          C = L.call(w, F), m.splice(P, 1), P--;
        }
        return C;
      }), t.formatArgs.call(w, m), (w.log || t.log).apply(w, m);
    }
    return g.namespace = f, g.useColors = t.useColors(), g.color = t.selectColor(f), g.extend = r, g.destroy = t.destroy, Object.defineProperty(g, "enabled", {
      enumerable: !0,
      configurable: !1,
      get: () => p !== null ? p : (b !== t.namespaces && (b = t.namespaces, E = t.enabled(f)), E),
      set: (m) => {
        p = m;
      }
  ...
  function r(f, h) {
    const p = t(this.namespace + (typeof h > "u" ? ":" : h) + f);
...
let SHA256$2 = class extends SHA2$1 {
  ...
  process(e, t) {
    for (let h = 0; h < 16; h++, t += 4)
      SHA256_W$2[h] = e.getUint32(t, !1);
    for (let h = 16; h < 64; h++) {
      const p = SHA256_W$2[h - 15], b = SHA256_W$2[h - 2], E = rotr$2(p, 7) ^ rotr$2(p, 18) ^ p >>> 3, g = rotr$2(b, 17) ^ rotr$2(b, 19) ^ b >>> 10;
      SHA256_W$2[h] = g + SHA256_W$2[h - 7] + E + SHA256_W$2[h - 16] | 0;
    }
    let { A: r, B: s, C: o, D: a, E: c, F: l, G: u, H: f } = this;
    for (let h = 0; h < 64; h++) {
      const p = rotr$2(c, 6) ^ rotr$2(c, 11) ^ rotr$2(c, 25), b = f + p + Chi$2(c, l, u) + SHA256_K$2[h] + SHA256_W$2[h] | 0, g = (rotr$2(r, 2) ^ rotr$2(r, 13) ^ rotr$2(r, 22)) + Maj$2(r, s, o) | 0;
      f = u, u = l, l = c, c = a + b | 0, a = o, o = s, s = r, r = b + g | 0;
    }
    r = r + this.A | 0, s = s + this.B | 0, o = o + this.C | 0, a = a + this.D | 0, c = c + this.E | 0, l = l + this.F | 0, u = u + this.G | 0, f = f + this.H | 0, this.set(r, s, o, a, c, l, u, f);
  }
  roundClean() {
    SHA256_W$2.fill(0);
  }
...
function createHmacDrbg$1(n, e, t) {
  ...
  }, c = (...h) => t(s, r, ...h), l = (h = u8n$1()) => {
    s = c(u8fr$1([0]), h), r = c(), h.length !== 0 && (s = c(u8fr$1([1]), h), r = c());
  }, u = () => {
    if (o++ >= 1e3)
...
function tonelliShanks$1(n) {
  ...
  return function(c, l) {
    if (c.pow(l, e) === c.neg(c.ONE))
      throw new Error("Cannot find square root");
    let u = r, f = c.pow(c.mul(c.ONE, s), t), h = c.pow(l, o), p = c.pow(l, t);
    for (; !c.eql(p, c.ONE); ) {
      if (c.eql(p, c.ZERO))
        return c.ZERO;
      let b = 1;
      for (let g = c.sqr(p); b < u && !c.eql(g, c.ONE); b++)
        g = c.sqr(g);
      const E = c.pow(f, _1n$8 << BigInt(u - b - 1));
      f = c.sqr(E), h = c.mul(h, E), p = c.mul(p, f), u = b;
    }
    return h;
  };
}
...
function wNAF$1(n, e) {
  ...
  return {
    ...
    wNAF(s, o, a) {
      ...
      const h = BigInt(2 ** s - 1), p = 2 ** s, b = BigInt(s);
      for (let E = 0; E < c; E++) {
        const g = E * l;
        let m = Number(a & h);
        a >>= b, m > l && (m -= p, a += _1n$7);
        const w = g, $ = g + Math.abs(m) - 1, B = E % 2 !== 0, P = m < 0;
        m === 0 ? f = f.add(t(B, o[w])) : u = u.add(t(P, o[$]));
      }
      return { p: u, f };
    },
    wNAFCached(s, o, a, c) {
...
function weierstrassPoints$1(n) {
  const e = validatePointOpts$1(n), { Fp: t } = e, r = e.toBytes || ((E, g, m) => {
    const w = g.toAffine();
    return concatBytes$3(Uint8Array.from([4]), t.toBytes(w.x), t.toBytes(w.y));
  }), s = e.fromBytes || ((E) => {
    const g = E.subarray(1), m = t.fromBytes(g.subarray(0, t.BYTES)), w = t.fromBytes(g.subarray(t.BYTES, 2 * t.BYTES));
    return { x: m, y: w };
  });
  function o(E) {
    const { a: g, b: m } = e, w = t.sqr(E), $ = t.mul(w, E);
    return t.add(t.add($, t.mul(E, g)), m);
  }
  ...
  function l(E) {
    const { allowedPrivateKeyLengths: g, nByteLength: m, wrapPrivateKey: w, n: $ } = e;
    ...
    let B;
    try {
      B = typeof E == "bigint" ? E : bytesToNumberBE$1(ensureBytes$1("private key", E, m));
    } catch {
      throw new Error(`private key must be ${m} bytes, hex or bigint, not ${typeof E}`);
    }
  ...
  class h {
    constructor(g, m, w) {
      if (this.px = g, this.py = m, this.pz = w, g == null || !t.isValid(g))
    ...
    static fromAffine(g) {
      const { x: m, y: w } = g || {};
      if (!g || !t.isValid(m) || !t.isValid(w))
        throw new Error("invalid affine point");
      if (g instanceof h)
        throw new Error("projective point not allowed");
      const $ = (B) => t.eql(B, t.ZERO);
      return $(m) && $(w) ? h.ZERO : new h(m, w, t.ONE);
    }
    get x() {
     ...
     */
    static normalizeZ(g) {
      const m = t.invertBatch(g.map((w) => w.pz));
      return g.map((w, $) => w.toAffine(m[$])).map(h.fromAffine);
    }
    /**
     ...
     */
    static fromHex(g) {
      const m = h.fromAffine(s(ensureBytes$1("pointHex", g)));
      return m.assertValidity(), m;
    }
    // Multiplies generator point by privateKey.
    static fromPrivateKey(g) {
      return h.BASE.multiply(l(g));
    }
    ...
    equals(g) {
      f(g);
      const { px: m, py: w, pz: $ } = this, { px: B, py: P, pz: M } = g, C = t.eql(t.mul(m, M), t.mul(B, $)), S = t.eql(t.mul(w, M), t.mul(P, $));
      return C && S;
    }
    /**
    ...
    double() {
      const { a: g, b: m } = e, w = t.mul(m, _3n$2), { px: $, py: B, pz: P } = this;
      let M = t.ZERO, C = t.ZERO, S = t.ZERO, L = t.mul($, $), F = t.mul(B, B), O = t.mul(P, P), k = t.mul($, B);
      return k = t.add(k, k), S = t.mul($, P), S = t.add(S, S), M = t.mul(g, S), C = t.mul(w, O), C = t.add(M, C), M = t.sub(F, C), C = t.add(F, C), C = t.mul(M, C), M = t.mul(k, M), S = t.mul(w, S), O = t.mul(g, O), k = t.sub(L, O), k = t.mul(g, k), k = t.add(k, S), S = t.add(L, L), L = t.add(S, L), L = t.add(L, O), L = t.mul(L, k), C = t.add(C, L), O = t.mul(B, P), O = t.add(O, O), L = t.mul(O, k), M = t.sub(M, L), S = t.mul(O, F), S = t.add(S, S), S = t.add(S, S), new h(M, C, S);
    }
    ...
    add(g) {
      f(g);
      const { px: m, py: w, pz: $ } = this, { px: B, py: P, pz: M } = g;
      let C = t.ZERO, S = t.ZERO, L = t.ZERO;
      const F = e.a, O = t.mul(e.b, _3n$2);
      let k = t.mul(m, B), _ = t.mul(w, P), T = t.mul($, M), A = t.add(m, w), v = t.add(B, P);
      A = t.mul(A, v), v = t.add(k, _), A = t.sub(A, v), v = t.add(m, $);
      let x = t.add(B, M);
      return v = t.mul(v, x), x = t.add(k, T), v = t.sub(v, x), x = t.add(w, $), C = t.add(P, M), x = t.mul(x, C), C = t.add(_, T), x = t.sub(x, C), L = t.mul(F, v), C = t.mul(O, T), L = t.add(C, L), C = t.sub(_, L), L = t.add(_, L), S = t.mul(C, L), _ = t.add(k, k), _ = t.add(_, k), T = t.mul(F, T), v = t.mul(O, v), _ = t.add(_, T), T = t.sub(k, T), T = t.mul(F, T), v = t.add(v, T), k = t.mul(_, v), S = t.add(S, k), k = t.mul(x, v), C = t.mul(A, C), C = t.sub(C, k), k = t.mul(A, _), L = t.mul(x, L), L = t.add(L, k), new h(C, S, L);
    }
    subtract(g) {
    ...
    wNAF(g) {
      return b.wNAFCached(this, u, g, (m) => {
        const w = t.invertBatch(m.map(($) => $.pz));
        return m.map(($, B) => $.toAffine(w[B])).map(h.fromAffine);
      });
    }
    /**
    ...
    multiplyUnsafe(g) {
      ...
      let { k1neg: $, k1: B, k2neg: P, k2: M } = w.splitScalar(g), C = m, S = m, L = this;
      for (; B > _0n$6 || M > _0n$6; )
        B & _1n$6 && (C = C.add(L)), M & _1n$6 && (S = S.add(L)), L = L.double(), B >>= _1n$6, M >>= _1n$6;
      return $ && (C = C.negate()), P && (S = S.negate()), S = new h(t.mul(S.px, w.beta), S.py, S.pz), C.add(S);
    }
    /**
    ...
    multiply(g) {
      ...
      const { endo: B } = e;
      if (B) {
        const { k1neg: P, k1: M, k2neg: C, k2: S } = B.splitScalar(m);
        let { p: L, f: F } = this.wNAF(M), { p: O, f: k } = this.wNAF(S);
        L = b.constTimeNegate(P, L), O = b.constTimeNegate(C, O), O = new h(t.mul(O.px, B.beta), O.py, O.pz), w = L.add(O), $ = F.add(k);
      } else {
        const { p: P, f: M } = this.wNAF(m);
        w = P, $ = M;
      }
      return h.normalizeZ([w, $])[0];
    }
    /**
     ...
     */
    multiplyAndAddUnsafe(g, m, w) {
      const $ = h.BASE, B = (M, C) => C === _0n$6 || C === _1n$6 || !M.equals($) ? M.multiplyUnsafe(C) : M.multiply(C), P = B(this, m).add(B(g, w));
    ...
    // (x, y, z) ∋ (x=x/z, y=y/z)
    toAffine(g) {
      const { px: m, py: w, pz: $ } = this, B = this.is0();
      g == null && (g = B ? t.ONE : t.inv($));
      const P = t.mul(m, g), M = t.mul(w, g), C = t.mul($, g);
      if (B)
    ...
    clearCofactor() {
      const { h: g, clearCofactor: m } = e;
      return g === _1n$6 ? this : m ? m(h, this) : this.multiplyUnsafe(e.h);
    }
    toRawBytes(g = !0) {
      return this.assertValidity(), r(h, this, g);
    }
    toHex(g = !0) {
  ...
  const p = e.nBitLength, b = wNAF$1(h, e.endo ? Math.ceil(p / 2) : p);
  return {
    CURVE: e,
    ProjectivePoint: h,
...
function weierstrass$1(n) {
  ...
  const { ProjectivePoint: u, normPrivateKeyToScalar: f, weierstrassEquation: h, isWithinCurveOrder: p } = weierstrassPoints$1({
    ...e,
    toBytes(v, x, R) {
      const N = x.toAffine(), I = t.toBytes(N.x), D = concatBytes$3;
      return R ? D(Uint8Array.from([x.hasEvenY() ? 2 : 3]), I) : D(Uint8Array.from([4]), I, t.toBytes(N.y));
    },
    fromBytes(v) {
      const x = v.length, R = v[0], N = v.subarray(1);
      if (x === s && (R === 2 || R === 3)) {
        ...
        const D = h(I);
        let U = t.sqrt(D);
        const H = (U & _1n$6) === _1n$6;
        return (R & 1) === 1 !== H && (U = t.neg(U)), { x: I, y: U };
      } else if (x === o && R === 4) {
  ...
  }), b = (v) => bytesToHex$3(numberToBytesBE$1(v, e.nByteLength));
  function E(v) {
    const x = r >> _1n$6;
    return v > x;
  }
  ...
  const m = (v, x, R) => bytesToNumberBE$1(v.slice(x, R));
  class w {
    constructor(x, R, N) {
      this.r = x, this.s = R, this.recovery = N, this.assertValidity();
    }
    // pair (bytes of r, bytes of s)
    static fromCompact(x) {
      const R = e.nByteLength;
      return x = ensureBytes$1("compactSignature", x, R * 2), new w(m(x, 0, R), m(x, R, 2 * R));
    }
    // DER encoded ECDSA signature
    // https://bitcoin.stackexchange.com/questions/57644/what-are-the-parts-of-a-bitcoin-transaction-input-script
    static fromDER(x) {
      const { r: R, s: N } = DER$1.toSig(ensureBytes$1("DER", x));
      return new w(R, N);
    }
    assertValidity() {
      if (!p(this.r))
    ...
    recoverPublicKey(x) {
      const { r: R, s: N, recovery: I } = this, D = S(ensureBytes$1("msgHash", x));
      if (I == null || ![0, 1, 2, 3].includes(I))
        throw new Error("recovery id invalid");
      const U = I === 2 || I === 3 ? R + e.n : R;
      if (U >= t.ORDER)
        throw new Error("recovery id 2 or 3 invalid");
      const H = I & 1 ? "03" : "02", z = u.fromHex(H + b(U)), V = l(U), W = c(-D * V), j = c(N * V), G = u.BASE.multiplyAndAddUnsafe(z, W, j);
      if (!G)
  ...
  const $ = {
     ...
     */
    precompute(v = 8, x = u.BASE) {
      return x._setWindowSize(v), x.multiply(BigInt(3)), x;
    }
  };
  function B(v, x = !0) {
    return u.fromPrivateKey(v).toRawBytes(x);
  }
  function P(v) {
    const x = v instanceof Uint8Array, R = typeof v == "string", N = (x || R) && v.length;
    return x ? N === s || N === o : R ? N === 2 * s || N === 2 * o : v instanceof u;
  }
  function M(v, x, R = !0) {
    if (P(v))
    ...
    return u.fromHex(x).multiply(f(v)).toRawBytes(R);
  }
  const C = e.bits2int || function(v) {
    const x = bytesToNumberBE$1(v), R = v.length * 8 - e.nBitLength;
  ...
  function O(v, x, R = k) {
    if (["recovered", "canonical"].some((Y) => Y in R))
      throw new Error("sign() legacy options not supported");
    const { hash: N, randomBytes: I } = e;
    let { lowS: D, prehash: U, extraEntropy: H } = R;
    D == null && (D = !0), v = ensureBytes$1("msgHash", v), U && (v = ensureBytes$1("prehashed msgHash", N(v)));
    const z = S(v), V = f(x), W = [F(V), F(z)];
    if (H != null) {
    ...
    function Z(Y) {
      ...
      if (!p(K))
        return;
      const se = l(K), J = u.BASE.multiply(K).toAffine(), q = c(J.x);
      if (q === _0n$6)
        return;
      const X = c(se * c(G + q * V));
      if (X === _0n$6)
        return;
      let te = (J.x === q ? 0 : 2) | Number(J.y & _1n$6), $e = X;
      return D && E(X) && ($e = g(X), te ^= 1), new w(q, $e, te);
    }
    return { seed: j, k2sig: Z };
  }
  const k = { lowS: e.lowS, prehash: !1 }, _ = { lowS: e.lowS, prehash: !1 };
  function T(v, x, R = k) {
    const { seed: N, k2sig: I } = O(v, x, R), D = e;
    return createHmacDrbg$1(D.hash.outputLen, D.nByteLength, D.hmac)(N, I);
  }
  u.BASE._setWindowSize(8);
  function A(v, x, R, N = _) {
    var J;
    const I = v;
    if (x = ensureBytes$1("msgHash", x), R = ensureBytes$1("publicKey", R), "strict" in N)
      throw new Error("options.strict was renamed to lowS");
    const { lowS: D, prehash: U } = N;
    let H, z;
    try {
    ...
    if (D && H.hasHighS())
      return !1;
    U && (x = e.hash(x));
    const { r: V, s: W } = H, j = S(x), G = l(W), Z = c(j * G), Y = c(V * G), K = (J = u.BASE.multiplyAndAddUnsafe(z, Z, Y)) == null ? void 0 : J.toAffine();
    return K ? c(K.x) === V : !1;
  }
  return {
    CURVE: e,
...
function sqrtMod$1(n) {
  const e = secp256k1P$1, t = BigInt(3), r = BigInt(6), s = BigInt(11), o = BigInt(22), a = BigInt(23), c = BigInt(44), l = BigInt(88), u = n * n * n % e, f = u * u * n % e, h = pow2$1(f, t, e) * f % e, p = pow2$1(h, t, e) * f % e, b = pow2$1(p, _2n$3, e) * u % e, E = pow2$1(b, s, e) * b % e, g = pow2$1(E, o, e) * E % e, m = pow2$1(g, c, e) * g % e, w = pow2$1(m, l, e) * m % e, $ = pow2$1(w, c, e) * g % e, B = pow2$1($, t, e) * f % e, P = pow2$1(B, a, e) * E % e, M = pow2$1(P, r, e) * u % e, C = pow2$1(M, _2n$3, e);
  if (!Fp.eql(Fp.sqr(C), n))
    throw new Error("Cannot find square root");
  return C;
}
const Fp = Field$1(secp256k1P$1, void 0, void 0, { sqrt: sqrtMod$1 }), secp256k1$1 = createCurve$1({
  ...
  endo: {
    ...
    splitScalar: (n) => {
      ...
      let u = mod$1(n - c * t - l * s, e), f = mod$1(-c * r - l * o, e);
      const h = u > a, p = f > a;
      if (h && (u = e - u), p && (f = e - f), u > a || f > a)
...
function schnorrSign$1(n, e, t = randomBytes$2(32)) {
  ...
  const { bytes: f, scalar: h } = schnorrGetExtPubKey$1(u), p = challenge$1(f, s, r), b = new Uint8Array(64);
  if (b.set(f, 0), b.set(numTo32b$1(modN$1(h + p * o)), 32), !schnorrVerify$1(b, r, s))
...
function schnorrVerify$1(n, e, t) {
  ...
  try {
    ...
    if (!ge(l))
      return !1;
    const u = challenge$1(numTo32b$1(c), pointToBytes$1(a), s), f = GmulAdd$1(a, l, modN$1(-u));
...
let SHA256$1 = class extends SHA2 {
  ...
  process(e, t) {
    for (let h = 0; h < 16; h++, t += 4)
      SHA256_W$1[h] = e.getUint32(t, !1);
    for (let h = 16; h < 64; h++) {
      const p = SHA256_W$1[h - 15], b = SHA256_W$1[h - 2], E = rotr$1(p, 7) ^ rotr$1(p, 18) ^ p >>> 3, g = rotr$1(b, 17) ^ rotr$1(b, 19) ^ b >>> 10;
      SHA256_W$1[h] = g + SHA256_W$1[h - 7] + E + SHA256_W$1[h - 16] | 0;
    }
    let { A: r, B: s, C: o, D: a, E: c, F: l, G: u, H: f } = this;
    for (let h = 0; h < 64; h++) {
      const p = rotr$1(c, 6) ^ rotr$1(c, 11) ^ rotr$1(c, 25), b = f + p + Chi$1(c, l, u) + SHA256_K$1[h] + SHA256_W$1[h] | 0, g = (rotr$1(r, 2) ^ rotr$1(r, 13) ^ rotr$1(r, 22)) + Maj$1(r, s, o) | 0;
      f = u, u = l, l = c, c = a + b | 0, a = o, o = s, s = r, r = b + g | 0;
    }
    r = r + this.A | 0, s = s + this.B | 0, o = o + this.C | 0, a = a + this.D | 0, c = c + this.E | 0, l = l + this.F | 0, u = u + this.G | 0, f = f + this.H | 0, this.set(r, s, o, a, c, l, u, f);
  }
...
function convertRadix(n, e, t) {
  ...
  for (o.forEach((a) => {
    ...
    for (let l = r; l < o.length; l++) {
      const u = o[l], f = e * a + u;
      if (!Number.isSafeInteger(f) || e * a / e !== a || f - u !== e * a)
        throw new Error("convertRadix: carry overflow");
      if (a = f % t, o[l] = Math.floor(f / t), !Number.isSafeInteger(o[l]) || o[l] * t + a !== f)
        throw new Error("convertRadix: carry overflow");
      if (c)
        o[l] ? c = !1 : r = l;
      else continue;
...
function genBech32(n) {
  ...
  function a(f, h, p = 90) {
    ...
    const b = f.length + 7 + h.length;
    if (p !== !1 && b > p)
      throw new TypeError(`Length ${b} exceeds limit ${p}`);
    return f = f.toLowerCase(), `${f}1${BECH_ALPHABET.encode(h)}${bechChecksum(f, h, e)}`;
  }
  function c(f, h = 90) {
    if (typeof f != "string")
      throw new Error(`bech32.decode input should be string, not ${typeof f}`);
    if (f.length < 8 || h !== !1 && f.length > h)
      throw new TypeError(`Wrong string length: ${f.length} (${f}). Expected (8..${h})`);
    ...
    const E = f.slice(0, b), g = f.slice(b + 1);
    if (g.length < 6)
      throw new Error("Data must be at least 6 characters long");
    const m = BECH_ALPHABET.decode(g).slice(0, -6), w = bechChecksum(E, m, e);
    if (!g.endsWith(w))
      throw new Error(`Invalid checksum in ${f}: expected "${w}"`);
    return { prefix: E, words: m };
  }
  const l = unsafeWrapper(c);
  function u(f) {
    const { prefix: h, words: p } = c(f, !1);
...
function genTtable(n, e) {
  ...
  const t = new Uint32Array(256).map((u, f) => e(n[f])), r = t.map(rotl32_8), s = r.map(rotl32_8), o = s.map(rotl32_8), a = new Uint32Array(256 * 256), c = new Uint32Array(256 * 256), l = new Uint16Array(256 * 256);
  for (let u = 0; u < 256; u++)
    for (let f = 0; f < 256; f++) {
      const h = u * 256 + f;
      a[h] = t[u] ^ r[f], c[h] = s[u] ^ o[f], l[h] = n[u] << 8 | n[f];
    }
...
function expandKeyDecLE(n) {
  ...
  e.fill(0);
  for (let u = 4; u < r - 4; u++) {
    const f = t[u], h = applySbox(s, f, f, f, f);
    t[u] = o[h & 255] ^ a[h >>> 8 & 255] ^ c[h >>> 16 & 255] ^ l[h >>> 24];
  }
  return t;
}
...
function encrypt$2(n, e, t, r, s) {
  ...
  for (let E = 0; E < u; E++) {
    const g = n[l++] ^ apply0123(a, c, e, t, r, s), m = n[l++] ^ apply0123(a, c, t, r, s, e), w = n[l++] ^ apply0123(a, c, r, s, e, t), $ = n[l++] ^ apply0123(a, c, s, e, t, r);
    e = g, t = m, r = w, s = $;
  }
  const f = n[l++] ^ applySbox(o, e, t, r, s), h = n[l++] ^ applySbox(o, t, r, s, e), p = n[l++] ^ applySbox(o, r, s, e, t), b = n[l++] ^ applySbox(o, s, e, t, r);
  return { s0: f, s1: h, s2: p, s3: b };
}
function decrypt$2(n, e, t, r, s) {
  ...
  const u = n.length / 4 - 2;
  for (let E = 0; E < u; E++) {
    const g = n[l++] ^ apply0123(a, c, e, s, r, t), m = n[l++] ^ apply0123(a, c, t, e, s, r), w = n[l++] ^ apply0123(a, c, r, t, e, s), $ = n[l++] ^ apply0123(a, c, s, r, t, e);
    e = g, t = m, r = w, s = $;
  }
  const f = n[l++] ^ applySbox(o, e, s, r, t), h = n[l++] ^ applySbox(o, t, e, s, r), p = n[l++] ^ applySbox(o, r, t, e, s), b = n[l++] ^ applySbox(o, s, r, t, e);
  return { s0: f, s1: h, s2: p, s3: b };
}
function getDst(n, e) {
  if (!e)
...
const cbc = /* @__PURE__ */ wrapCipher({ blockSize: 16, nonceLength: 16 }, function n(e, t, r = {}) {
  ...
  return {
    encrypt: (o, a) => {
      const c = expandKeyLE(e), { b: l, o: u, out: f } = validateBlockEncrypt(o, s, a), h = u32(t);
      let p = h[0], b = h[1], E = h[2], g = h[3], m = 0;
      for (; m + 4 <= l.length; )
        p ^= l[m + 0], b ^= l[m + 1], E ^= l[m + 2], g ^= l[m + 3], { s0: p, s1: b, s2: E, s3: g } = encrypt$2(c, p, b, E, g), u[m++] = p, u[m++] = b, u[m++] = E, u[m++] = g;
      if (s) {
        const w = padPCKS(o.subarray(m * 4));
        p ^= w[0], b ^= w[1], E ^= w[2], g ^= w[3], { s0: p, s1: b, s2: E, s3: g } = encrypt$2(c, p, b, E, g), u[m++] = p, u[m++] = b, u[m++] = E, u[m++] = g;
      }
      return c.fill(0), f;
    },
    decrypt: (o, a) => {
      validateBlockDecrypt(o);
      const c = expandKeyDecLE(e), l = u32(t), u = getDst(o.length, a), f = u32(o), h = u32(u);
      let p = l[0], b = l[1], E = l[2], g = l[3];
      for (let m = 0; m + 4 <= f.length; ) {
        const w = p, $ = b, B = E, P = g;
        p = f[m + 0], b = f[m + 1], E = f[m + 2], g = f[m + 3];
        const { s0: M, s1: C, s2: S, s3: L } = decrypt$2(c, p, b, E, g);
        h[m++] = M ^ w, h[m++] = C ^ $, h[m++] = S ^ B, h[m++] = L ^ P;
      }
...
function runCipher(n, e, t, r, s, o, a, c) {
  const l = s.length, u = new Uint8Array(BLOCK_LEN), f = u32(u), h = isAligned32(s) && isAligned32(o), p = h ? u32(s) : U32_EMPTY, b = h ? u32(o) : U32_EMPTY;
  for (let E = 0; E < l; a++) {
    if (n(e, t, r, f, a, c), a >= MAX_COUNTER)
...
function createCipher(n, e) {
  ...
  return number(s), number(a), bool(o), bool(t), (c, l, u, f, h = 0) => {
    bytes(c), bytes(l), bytes(u);
    const p = u.length;
    if (f || (f = new Uint8Array(p)), bytes(f), number(h), h < 0 || h >= MAX_COUNTER)
      throw new Error("arx: counter overflow");
    if (f.length < p)
    ...
    let E = c.length, g, m;
    if (E === 32)
      g = c.slice(), b.push(g), m = sigma32_32;
    else if (E === 16 && t)
      g = new Uint8Array(32), g.set(c), g.set(c, 16), m = sigma16_32, b.push(g);
    else
      throw new Error(`arx: invalid 32-byte key, got length=${E}`);
    isAligned32(l) || (l = l.slice(), b.push(l));
    const w = u32(g);
    if (r) {
      if (l.length !== 24)
        throw new Error("arx: extended nonce must be 24 bytes");
      r(m, w, u32(l.subarray(0, 16)), w), l = l.subarray(16);
    }
    const $ = 16 - s;
    if ($ !== l.length)
    ...
    if ($ !== 12) {
      ...
      P.set(l, o ? 0 : 12 - l.length), l = P, b.push(l);
    }
    const B = u32(l);
    for (runCipher(n, m, w, B, u, f, h, a); b.length > 0; )
      b.pop().fill(0);
    return f;
  };
}
function chachaCore(n, e, t, r, s, o = 20) {
  let a = n[0], c = n[1], l = n[2], u = n[3], f = e[0], h = e[1], p = e[2], b = e[3], E = e[4], g = e[5], m = e[6], w = e[7], $ = s, B = t[0], P = t[1], M = t[2], C = a, S = c, L = l, F = u, O = f, k = h, _ = p, T = b, A = E, v = g, x = m, R = w, N = $, I = B, D = P, U = M;
  for (let z = 0; z < o; z += 2)
    C = C + O | 0, N = rotl(N ^ C, 16), A = A + N | 0, O = rotl(O ^ A, 12), C = C + O | 0, N = rotl(N ^ C, 8), A = A + N | 0, O = rotl(O ^ A, 7), S = S + k | 0, I = rotl(I ^ S, 16), v = v + I | 0, k = rotl(k ^ v, 12), S = S + k | 0, I = rotl(I ^ S, 8), v = v + I | 0, k = rotl(k ^ v, 7), L = L + _ | 0, D = rotl(D ^ L, 16), x = x + D | 0, _ = rotl(_ ^ x, 12), L = L + _ | 0, D = rotl(D ^ L, 8), x = x + D | 0, _ = rotl(_ ^ x, 7), F = F + T | 0, U = rotl(U ^ F, 16), R = R + U | 0, T = rotl(T ^ R, 12), F = F + T | 0, U = rotl(U ^ F, 8), R = R + U | 0, T = rotl(T ^ R, 7), C = C + k | 0, U = rotl(U ^ C, 16), x = x + U | 0, k = rotl(k ^ x, 12), C = C + k | 0, U = rotl(U ^ C, 8), x = x + U | 0, k = rotl(k ^ x, 7), S = S + _ | 0, N = rotl(N ^ S, 16), R = R + N | 0, _ = rotl(_ ^ R, 12), S = S + _ | 0, N = rotl(N ^ S, 8), R = R + N | 0, _ = rotl(_ ^ R, 7), L = L + T | 0, I = rotl(I ^ L, 16), A = A + I | 0, T = rotl(T ^ A, 12), L = L + T | 0, I = rotl(I ^ L, 8), A = A + I | 0, T = rotl(T ^ A, 7), F = F + O | 0, D = rotl(D ^ F, 16), v = v + D | 0, O = rotl(O ^ v, 12), F = F + O | 0, D = rotl(D ^ F, 8), v = v + D | 0, O = rotl(O ^ v, 7);
  let H = 0;
  r[H++] = a + C | 0, r[H++] = c + S | 0, r[H++] = l + L | 0, r[H++] = u + F | 0, r[H++] = f + O | 0, r[H++] = h + k | 0, r[H++] = p + _ | 0, r[H++] = b + T | 0, r[H++] = E + A | 0, r[H++] = g + v | 0, r[H++] = m + x | 0, r[H++] = w + R | 0, r[H++] = $ + N | 0, r[H++] = B + I | 0, r[H++] = P + D | 0, r[H++] = M + U | 0;
}
  ...
  switch (e) {
    case "nprofile": {
      ...
      return {
        type: "nprofile",
        data: {
          pubkey: bytesToHex$2(h[0][0]),
          relays: h[1] ? h[1].map((p) => utf8Decoder.decode(p)) : []
        }
      };
    }
    case "nevent": {
      ...
      if (h[0][0].length !== 32)
        throw new Error("TLV 0 should be 32 bytes");
      if (h[2] && h[2][0].length !== 32)
        throw new Error("TLV 2 should be 32 bytes");
      if (h[3] && h[3][0].length !== 4)
        throw new Error("TLV 3 should be 4 bytes");
      return {
        type: "nevent",
        data: {
          id: bytesToHex$2(h[0][0]),
          relays: h[1] ? h[1].map((p) => utf8Decoder.decode(p)) : [],
          author: (a = h[2]) != null && a[0] ? bytesToHex$2(h[2][0]) : void 0,
          kind: (c = h[3]) != null && c[0] ? parseInt(bytesToHex$2(h[3][0]), 16) : void 0
        }
      };
    }
    case "naddr": {
      ...
      return {
        type: "naddr",
        data: {
          identifier: utf8Decoder.decode(h[0][0]),
          pubkey: bytesToHex$2(h[2][0]),
          kind: parseInt(bytesToHex$2(h[3][0]), 16),
          relays: h[1] ? h[1].map((p) => utf8Decoder.decode(p)) : []
        }
      };
    }
...
function encrypt$1(n, e, t) {
  ...
  let a = Uint8Array.from(randomBytes$1(16)), c = utf8Encoder.encode(t), l = cbc(o, a).encrypt(c), u = base64.encode(new Uint8Array(l)), f = base64.encode(new Uint8Array(a.buffer));
  return `${u}?iv=${f}`;
}
function decrypt$1(n, e, t) {
  const r = n instanceof Uint8Array ? bytesToHex$2(n) : n;
  let [s, o] = t.split("?iv="), a = secp256k1$1.getSharedSecret(r, "02" + e), c = getNormalizedX(a), l = base64.decode(o), u = base64.decode(s), f = cbc(c, l).decrypt(u);
  return utf8Decoder.decode(f);
}
...
var v2 = {
  ...
  encrypt: encrypt2,
  decrypt: decrypt2
}, TWO_DAYS = 2 * 24 * 60 * 60, now = () => Math.round(Date.now() / 1e3), randomNow = () => Math.round(now() - Math.random() * TWO_DAYS), nip44ConversationKey = (n, e) => getConversationKey(n, e), nip44Encrypt = (n, e, t) => encrypt2(JSON.stringify(n), nip44ConversationKey(e, t)), nip44Decrypt = (n, e) => JSON.parse(decrypt2(n.content, nip44ConversationKey(e, n.pubkey)));
...
class SHA256 extends HashMD {
  ...
  process(e, t) {
    for (let h = 0; h < 16; h++, t += 4)
      SHA256_W[h] = e.getUint32(t, !1);
    for (let h = 16; h < 64; h++) {
      const p = SHA256_W[h - 15], b = SHA256_W[h - 2], E = rotr(p, 7) ^ rotr(p, 18) ^ p >>> 3, g = rotr(b, 17) ^ rotr(b, 19) ^ b >>> 10;
      SHA256_W[h] = g + SHA256_W[h - 7] + E + SHA256_W[h - 16] | 0;
    }
    let { A: r, B: s, C: o, D: a, E: c, F: l, G: u, H: f } = this;
    for (let h = 0; h < 64; h++) {
      const p = rotr(c, 6) ^ rotr(c, 11) ^ rotr(c, 25), b = f + p + Chi(c, l, u) + SHA256_K[h] + SHA256_W[h] | 0, g = (rotr(r, 2) ^ rotr(r, 13) ^ rotr(r, 22)) + Maj(r, s, o) | 0;
      f = u, u = l, l = c, c = a + b | 0, a = o, o = s, s = r, r = b + g | 0;
    }
    r = r + this.A | 0, s = s + this.B | 0, o = o + this.C | 0, a = a + this.D | 0, c = c + this.E | 0, l = l + this.F | 0, u = u + this.G | 0, f = f + this.H | 0, this.set(r, s, o, a, c, l, u, f);
  }
...
function createHmacDrbg(n, e, t) {
  ...
  const a = () => {
    ...
    s = c(u8fr([0]), h), r = c(), h.length !== 0 && (s = c(u8fr([1]), h), r = c());
  }, u = () => {
    if (o++ >= 1e3)
      throw new Error("drbg: tried 1000 values");
    let h = 0;
...
function tonelliShanks(n) {
  ...
  return function(c, l) {
    ...
    for (; !c.eql(p, c.ONE); ) {
      ...
      for (let g = c.sqr(p); b < u && !c.eql(g, c.ONE); b++)
        g = c.sqr(g);
      const E = c.pow(f, _1n$3 << BigInt(u - b - 1));
      f = c.sqr(E), h = c.mul(h, E), p = c.mul(p, f), u = b;
    }
    return h;
  };
...
function wNAF(n, e) {
  return {
    ...
    wNAF(t, r, s) {
      ...
      const u = BigInt(2 ** t - 1), f = 2 ** t, h = BigInt(t);
      for (let p = 0; p < o; p++) {
        const b = p * a;
        let E = Number(s & u);
        s >>= h, E > a && (E -= f, s += _1n$2);
        const g = b, m = b + Math.abs(E) - 1, w = p % 2 !== 0, $ = E < 0;
        E === 0 ? l = l.add(constTimeNegate(w, r[g])) : c = c.add(constTimeNegate($, r[m]));
      }
      return { p: c, f: l };
    },
    /**
    ...
    wNAFUnsafe(t, r, s, o = n.ZERO) {
      const { windows: a, windowSize: c } = calcWOpts(t, e), l = BigInt(2 ** t - 1), u = 2 ** t, f = BigInt(t);
      for (let h = 0; h < a; h++) {
        const p = h * c;
        if (s === _0n$2)
          break;
        let b = Number(s & l);
        if (s >>= f, b > c && (b -= u, s += _1n$2), b === 0)
          continue;
        let E = r[p + Math.abs(b) - 1];
        b < 0 && (E = E.negate()), o = o.add(E);
      }
      return o;
    },
...
function pippenger(n, e, t, r) {
  ...
  for (let h = u; h >= 0; h -= a) {
    ...
    for (let b = 0; b < r.length; b++) {
      const E = r[b], g = Number(E >> BigInt(h) & BigInt(c));
      l[g] = l[g].add(t[b]);
    }
    let p = s;
    for (let b = l.length - 1, E = s; b > 0; b--)
      E = E.add(l[b]), p = p.add(E);
    if (f = f.add(p), h !== 0)
      for (let b = 0; b < a; b++)
        f = f.double();
  }
...
const DER = {
  ...
  toSig(n) {
    ...
    if (a.length)
      throw new e("invalid signature: left bytes after parsing");
    const { v: c, l } = r.decode(2, o), { v: u, l: f } = r.decode(2, l);
    if (f.length)
      throw new e("invalid signature: left bytes after parsing");
...
function weierstrassPoints(n) {
  const e = validatePointOpts(n), { Fp: t } = e, r = Field(e.n, e.nBitLength), s = e.toBytes || ((g, m, w) => {
    const $ = m.toAffine();
    return concatBytes(Uint8Array.from([4]), t.toBytes($.x), t.toBytes($.y));
  }), o = e.fromBytes || ((g) => {
    const m = g.subarray(1), w = t.fromBytes(m.subarray(0, t.BYTES)), $ = t.fromBytes(m.subarray(t.BYTES, 2 * t.BYTES));
    return { x: w, y: $ };
  });
  function a(g) {
    const { a: m, b: w } = e, $ = t.sqr(g), B = t.mul($, g);
    return t.add(t.add(B, t.mul(g, m)), w);
  }
  ...
  function l(g) {
    const { allowedPrivateKeyLengths: m, nByteLength: w, wrapPrivateKey: $, n: B } = e;
    if (m && typeof g != "bigint") {
      if (isBytes(g) && (g = bytesToHex(g)), typeof g != "string" || !m.includes(g.length))
  ...
  const f = memoized((g, m) => {
    const { px: w, py: $, pz: B } = g;
    if (t.eql(B, t.ONE))
      return { x: w, y: $ };
    const P = g.is0();
    m == null && (m = P ? t.ONE : t.inv(B));
    const M = t.mul(w, m), C = t.mul($, m), S = t.mul(B, m);
    if (P)
      return { x: t.ZERO, y: t.ZERO };
    if (!t.eql(S, t.ONE))
      throw new Error("invZ was invalid");
  ...
  class p {
    constructor(m, w, $) {
      if (this.px = m, this.py = w, this.pz = $, m == null || !t.isValid(m))
        throw new Error("x required");
      if (w == null || !t.isValid(w))
        throw new Error("y required");
      if ($ == null || !t.isValid($))
    ...
    static normalizeZ(m) {
      const w = t.invertBatch(m.map(($) => $.pz));
      return m.map(($, B) => $.toAffine(w[B])).map(p.fromAffine);
    }
    /**
     * Converts hash string or Uint8Array to Point.
     * @param hex short/long ECDSA hex
     */
    static fromHex(m) {
      const w = p.fromAffine(o(ensureBytes("pointHex", m)));
      return w.assertValidity(), w;
    }
    // Multiplies generator point by privateKey.
    static fromPrivateKey(m) {
      return p.BASE.multiply(l(m));
    }
    // Multiscalar Multiplication
    static msm(m, w) {
      return pippenger(p, r, m, w);
    }
    // "Private method", don't use it directly
    _setWindowSize(m) {
      E.setWindowSize(this, m);
    }
    // A point on curve is valid if it conforms to equation.
    assertValidity() {
      h(this);
    ...
    equals(m) {
      u(m);
      const { px: w, py: $, pz: B } = this, { px: P, py: M, pz: C } = m, S = t.eql(t.mul(w, C), t.mul(P, B)), L = t.eql(t.mul($, C), t.mul(M, B));
      return S && L;
    }
    /**
     * Flips point to one corresponding to (x, -y) in Affine coordinates.
    ...
    // Cost: 8M + 3S + 3*a + 2*b3 + 15add.
    double() {
      const { a: m, b: w } = e, $ = t.mul(w, _3n), { px: B, py: P, pz: M } = this;
      let C = t.ZERO, S = t.ZERO, L = t.ZERO, F = t.mul(B, B), O = t.mul(P, P), k = t.mul(M, M), _ = t.mul(B, P);
      return _ = t.add(_, _), L = t.mul(B, M), L = t.add(L, L), C = t.mul(m, L), S = t.mul($, k), S = t.add(C, S), C = t.sub(O, S), S = t.add(O, S), S = t.mul(C, S), C = t.mul(_, C), L = t.mul($, L), k = t.mul(m, k), _ = t.sub(F, k), _ = t.mul(m, _), _ = t.add(_, L), L = t.add(F, F), F = t.add(L, F), F = t.add(F, k), F = t.mul(F, _), S = t.add(S, F), k = t.mul(P, M), k = t.add(k, k), F = t.mul(k, _), C = t.sub(C, F), L = t.mul(k, O), L = t.add(L, L), L = t.add(L, L), new p(C, S, L);
    }
    // Renes-Costello-Batina exception-free addition formula.
    // There is 30% faster Jacobian formula, but it is not complete.
    // https://eprint.iacr.org/2015/1060, algorithm 1
    ...
    add(m) {
      u(m);
      const { px: w, py: $, pz: B } = this, { px: P, py: M, pz: C } = m;
      let S = t.ZERO, L = t.ZERO, F = t.ZERO;
      const O = e.a, k = t.mul(e.b, _3n);
      let _ = t.mul(w, P), T = t.mul($, M), A = t.mul(B, C), v = t.add(w, $), x = t.add(P, M);
      v = t.mul(v, x), x = t.add(_, T), v = t.sub(v, x), x = t.add(w, B);
      let R = t.add(P, C);
      return x = t.mul(x, R), R = t.add(_, A), x = t.sub(x, R), R = t.add($, B), S = t.add(M, C), R = t.mul(R, S), S = t.add(T, A), R = t.sub(R, S), F = t.mul(O, x), S = t.mul(k, A), F = t.add(S, F), S = t.sub(T, F), F = t.add(T, F), L = t.mul(S, F), T = t.add(_, _), T = t.add(T, _), A = t.mul(O, A), x = t.mul(k, x), T = t.add(T, A), A = t.sub(_, A), A = t.mul(O, A), x = t.add(x, A), _ = t.mul(T, x), L = t.add(L, _), _ = t.mul(R, x), S = t.mul(v, S), S = t.sub(S, _), _ = t.mul(v, T), F = t.mul(R, F), F = t.add(F, _), new p(S, L, F);
    }
    subtract(m) {
    ...
    wNAF(m) {
      return E.wNAFCached(this, m, p.normalizeZ);
    }
    /**
     * Non-constant-time multiplication. Uses double-and-add algorithm.
     * It's faster, but should only be used when you don't care about
    ...
    multiplyUnsafe(m) {
      ...
      if (!w || E.hasPrecomputes(this))
        return E.wNAFCachedUnsafe(this, m, p.normalizeZ);
      let { k1neg: P, k1: M, k2neg: C, k2: S } = w.splitScalar(m), L = B, F = B, O = this;
      for (; M > _0n$1 || S > _0n$1; )
        M & _1n$1 && (L = L.add(O)), S & _1n$1 && (F = F.add(O)), O = O.double(), M >>= _1n$1, S >>= _1n$1;
      return P && (L = L.negate()), C && (F = F.negate()), F = new p(t.mul(F.px, w.beta), F.py, F.pz), L.add(F);
    }
    /**
     * Constant time multiplication.
     * Uses wNAF method. Windowed method may be 10% faster,
    ...
    multiply(m) {
      const { endo: w, n: $ } = e;
      aInRange("scalar", m, _1n$1, $);
      let B, P;
      if (w) {
        const { k1neg: M, k1: C, k2neg: S, k2: L } = w.splitScalar(m);
        let { p: F, f: O } = this.wNAF(C), { p: k, f: _ } = this.wNAF(L);
        F = E.constTimeNegate(M, F), k = E.constTimeNegate(S, k), k = new p(t.mul(k.px, w.beta), k.py, k.pz), B = F.add(k), P = O.add(_);
      } else {
        const { p: M, f: C } = this.wNAF(m);
        B = M, P = C;
      }
     ...
     * @returns non-zero affine point
     */
    multiplyAndAddUnsafe(m, w, $) {
      const B = p.BASE, P = (C, S) => S === _0n$1 || S === _1n$1 || !C.equals(B) ? C.multiplyUnsafe(S) : C.multiply(S), M = P(this, w).add(P(m, $));
    ...
    clearCofactor() {
      const { h: m, clearCofactor: w } = e;
      return m === _1n$1 ? this : w ? w(p, this) : this.multiplyUnsafe(e.h);
    }
    toRawBytes(m = !0) {
      return abool("isCompressed", m), this.assertValidity(), s(p, this, m);
    }
    toHex(m = !0) {
      return abool("isCompressed", m), bytesToHex(this.toRawBytes(m));
    }
  }
  p.BASE = new p(e.Gx, e.Gy, t.ONE), p.ZERO = new p(t.ZERO, t.ONE, t.ZERO);
  const b = e.nBitLength, E = wNAF(p, e.endo ? Math.ceil(b / 2) : b);
  return {
    CURVE: e,
    ProjectivePoint: p,
    normPrivateKeyToScalar: l,
...
function weierstrass(n) {
  ...
  const { ProjectivePoint: l, normPrivateKeyToScalar: u, weierstrassEquation: f, isWithinCurveOrder: h } = weierstrassPoints({
    ...e,
    toBytes(A, v, x) {
      const R = v.toAffine(), N = t.toBytes(R.x), I = concatBytes;
      return abool("isCompressed", x), x ? I(Uint8Array.from([v.hasEvenY() ? 2 : 3]), N) : I(Uint8Array.from([4]), N, t.toBytes(R.y));
    },
    fromBytes(A) {
      const v = A.length, x = A[0], R = A.subarray(1);
      if (v === s && (x === 2 || x === 3)) {
        const N = bytesToNumberBE(R);
        ...
        const U = (D & _1n$1) === _1n$1;
        return (x & 1) === 1 !== U && (D = t.neg(D)), { x: N, y: D };
      } else if (v === o && x === 4) {
        const N = t.fromBytes(R.subarray(0, t.BYTES)), I = t.fromBytes(R.subarray(t.BYTES, 2 * t.BYTES));
        return { x: N, y: I };
      } else {
        const N = s, I = o;
  ...
  }), p = (A) => bytesToHex(numberToBytesBE(A, e.nByteLength));
  function b(A) {
    const v = r >> _1n$1;
    return A > v;
  }
  ...
  const g = (A, v, x) => bytesToNumberBE(A.slice(v, x));
  class m {
    constructor(v, x, R) {
      this.r = v, this.s = x, this.recovery = R, this.assertValidity();
    }
    // pair (bytes of r, bytes of s)
    static fromCompact(v) {
      const x = e.nByteLength;
      return v = ensureBytes("compactSignature", v, x * 2), new m(g(v, 0, x), g(v, x, 2 * x));
    }
    // DER encoded ECDSA signature
    // https://bitcoin.stackexchange.com/questions/57644/what-are-the-parts-of-a-bitcoin-transaction-input-script
    static fromDER(v) {
      const { r: x, s: R } = DER.toSig(ensureBytes("DER", v));
      return new m(x, R);
    }
    assertValidity() {
    ...
    recoverPublicKey(v) {
      const { r: x, s: R, recovery: N } = this, I = C(ensureBytes("msgHash", v));
      if (N == null || ![0, 1, 2, 3].includes(N))
        throw new Error("recovery id invalid");
      const D = N === 2 || N === 3 ? x + e.n : x;
      if (D >= t.ORDER)
        throw new Error("recovery id 2 or 3 invalid");
      const U = N & 1 ? "03" : "02", H = l.fromHex(U + p(D)), z = c(D), V = a(-I * z), W = a(R * z), j = l.BASE.multiplyAndAddUnsafe(H, V, W);
      if (!j)
        throw new Error("point at infinify");
  ...
  const w = {
     ...
     */
    randomPrivateKey: () => {
      const A = getMinHashLength(e.n);
      return mapHashToField(e.randomBytes(A), e.n);
    },
    /**
     * Creates precompute table for an arbitrary EC point. Makes point "cached".
     * Allows to massively speed-up `point.multiply(scalar)`.
     ...
     * fast.multiply(privKey); // much faster ECDH now
     */
    precompute(A = 8, v = l.BASE) {
      return v._setWindowSize(A), v.multiply(BigInt(3)), v;
    }
  };
  function $(A, v = !0) {
    return l.fromPrivateKey(A).toRawBytes(v);
  }
  function B(A) {
    const v = isBytes(A), x = typeof A == "string", R = (v || x) && A.length;
    return v ? R === s || R === o : x ? R === 2 * s || R === 2 * o : A instanceof l;
  }
  function P(A, v, x = !0) {
    if (B(A))
      throw new Error("first arg must be private key");
    if (!B(v))
      throw new Error("second arg must be public key");
    return l.fromHex(v).multiply(u(A)).toRawBytes(x);
  }
  const M = e.bits2int || function(A) {
    if (A.length > 8192)
      throw new Error("input is too large");
    const v = bytesToNumberBE(A), x = A.length * 8 - e.nBitLength;
    return x > 0 ? v >> BigInt(x) : v;
  }, C = e.bits2int_modN || function(A) {
    return a(M(A));
  }, S = bitMask(e.nBitLength);
  function L(A) {
    return aInRange("num < 2^" + e.nBitLength, A, _0n$1, S), numberToBytesBE(A, e.nByteLength);
  }
  function F(A, v, x = O) {
    if (["recovered", "canonical"].some((Z) => Z in x))
      throw new Error("sign() legacy options not supported");
    const { hash: R, randomBytes: N } = e;
    let { lowS: I, prehash: D, extraEntropy: U } = x;
    I == null && (I = !0), A = ensureBytes("msgHash", A), validateSigVerOpts(x), D && (A = ensureBytes("prehashed msgHash", R(A)));
    const H = C(A), z = u(v), V = [L(z), L(H)];
    if (U != null && U !== !1) {
      const Z = U === !0 ? N(t.BYTES) : U;
    ...
    function G(Z) {
      ...
      if (!h(Y))
        return;
      const K = c(Y), se = l.BASE.multiply(Y).toAffine(), J = a(se.x);
      if (J === _0n$1)
        return;
      const q = a(K * a(j + J * z));
      if (q === _0n$1)
        return;
      let X = (se.x === J ? 0 : 2) | Number(se.y & _1n$1), te = q;
      return I && b(q) && (te = E(q), X ^= 1), new m(J, te, X);
    }
    return { seed: W, k2sig: G };
  }
  const O = { lowS: e.lowS, prehash: !1 }, k = { lowS: e.lowS, prehash: !1 };
  function _(A, v, x = O) {
    const { seed: R, k2sig: N } = F(A, v, x), I = e;
    return createHmacDrbg(I.hash.outputLen, I.nByteLength, I.hmac)(R, N);
  }
  l.BASE._setWindowSize(8);
  function T(A, v, x, R = k) {
    var X;
    const N = A;
    v = ensureBytes("msgHash", v), x = ensureBytes("publicKey", x);
    const { lowS: I, prehash: D, format: U } = R;
    if (validateSigVerOpts(R), "strict" in R)
      throw new Error("options.strict was renamed to lowS");
    if (U !== void 0 && U !== "compact" && U !== "der")
      throw new Error("format must be compact or der");
    const H = typeof N == "string" || isBytes(N), z = !H && !U && typeof N == "object" && N !== null && typeof N.r == "bigint" && typeof N.s == "bigint";
    if (!H && !z)
      throw new Error("invalid signature, expected Uint8Array, hex string or Signature instance");
    let V, W;
    try {
      if (z && (V = new m(N.r, N.s)), H) {
        try {
          U !== "compact" && (V = m.fromDER(N));
        } catch (te) {
          if (!(te instanceof DER.Err))
            throw te;
        }
        !V && U !== "der" && (V = m.fromCompact(N));
      }
      W = l.fromHex(x);
    } catch {
      return !1;
    ...
    if (!V || I && V.hasHighS())
      return !1;
    D && (v = e.hash(v));
    const { r: j, s: G } = V, Z = C(v), Y = c(G), K = a(Z * Y), se = a(j * Y), J = (X = l.BASE.multiplyAndAddUnsafe(W, K, se)) == null ? void 0 : X.toAffine();
    return J ? a(J.x) === j : !1;
  }
  return {
    CURVE: e,
...
function sqrtMod(n) {
  const e = secp256k1P, t = BigInt(3), r = BigInt(6), s = BigInt(11), o = BigInt(22), a = BigInt(23), c = BigInt(44), l = BigInt(88), u = n * n * n % e, f = u * u * n % e, h = pow2(f, t, e) * f % e, p = pow2(h, t, e) * f % e, b = pow2(p, _2n, e) * u % e, E = pow2(b, s, e) * b % e, g = pow2(E, o, e) * E % e, m = pow2(g, c, e) * g % e, w = pow2(m, l, e) * m % e, $ = pow2(w, c, e) * g % e, B = pow2($, t, e) * f % e, P = pow2(B, a, e) * E % e, M = pow2(P, r, e) * u % e, C = pow2(M, _2n, e);
  if (!Fpk1.eql(Fpk1.sqr(C), n))
    throw new Error("Cannot find square root");
  return C;
}
const Fpk1 = Field(secp256k1P, void 0, void 0, { sqrt: sqrtMod }), secp256k1 = createCurve({
  ...
  endo: {
    ...
    splitScalar: (n) => {
      ...
      let u = mod(n - c * t - l * s, e), f = mod(-c * r - l * o, e);
      const h = u > a, p = f > a;
      if (h && (u = e - u), p && (f = e - f), u > a || f > a)
        throw new Error("splitScalar: Endomorphism failed, k=" + n);
      return { k1neg: h, k1: u, k2neg: p, k2: f };
...
function schnorrSign(n, e, t = randomBytes(32)) {
  ...
  if (u === _0n)
    throw new Error("sign failed: k is zero");
  const { bytes: f, scalar: h } = schnorrGetExtPubKey(u), p = challenge(f, s, r), b = new Uint8Array(64);
  if (b.set(f, 0), b.set(numTo32b(modN(h + p * o)), 32), !schnorrVerify(b, r, s))
    throw new Error("sign: Invalid signature produced");
  return b;
}
function schnorrVerify(n, e, t) {
  ...
  try {
    ...
    if (!inRange(l, _1n, secp256k1N))
      return !1;
    const u = challenge(numTo32b(c), pointToBytes(a), s), f = GmulAdd(a, l, modN(-u));
    return !(!f || !f.hasEvenY() || f.toAffine().x !== c);
  } catch {
    return !1;
  }
...
class LRUCacheNode {
  constructor(e, t, r) {
    const { entryExpirationTimeInMS: s = null, next: o = null, prev: a = null, onEntryEvicted: c, onEntryMarkedAsMostRecentlyUsed: l, clone: u, cloneFn: f } = r ?? {};
    if (typeof s == "number" && (s <= 0 || Number.isNaN(s)))
      throw new Error("entryExpirationTimeInMS must either be null (no expiry) or greater than 0");
    this.clone = u ?? !1, this.cloneFn = f ?? this.defaultClone, this.key = e, this.internalValue = this.clone ? this.cloneFn(t) : t, this.created = Date.now(), this.entryExpirationTimeInMS = s, this.next = o, this.prev = a, this.onEntryEvicted = c, this.onEntryMarkedAsMostRecentlyUsed = l;
  }
  get value() {
...
(function(n) {
  ...
  n.assertNumber = e;
  function t(...k) {
    const _ = (v, x) => (R) => v(x(R)), T = Array.from(k).reverse().reduce((v, x) => v ? _(v, x.encode) : x.encode, void 0), A = k.reduce((v, x) => v ? _(v, x.decode) : x.decode, void 0);
    return { encode: T, decode: A };
  }
  function r(k) {
    return {
      encode: (_) => {
        if (!Array.isArray(_) || _.length && typeof _[0] != "number")
          throw new Error("alphabet.encode input should be an array of numbers");
        return _.map((T) => {
          if (e(T), T < 0 || T >= k.length)
            throw new Error(`Digit index outside alphabet: ${T} (alphabet: ${k.length})`);
          return k[T];
        });
      },
      decode: (_) => {
        ...
        return _.map((T) => {
          ...
          const A = k.indexOf(T);
          if (A === -1)
            throw new Error(`Unknown letter: "${T}". Allowed: ${k}`);
          return A;
        });
      }
    };
  ...
  function o(k, _ = "=") {
    ...
    return {
      encode(T) {
        ...
        for (let A of T)
          if (typeof A != "string")
            throw new Error(`padding.encode: non-string input=${A}`);
        for (; T.length * k % 8; )
          T.push(_);
        return T;
      },
  ...
  function a(k) {
    if (typeof k != "function")
      throw new Error("normalize fn should be function");
    return { encode: (_) => _, decode: (_) => k(_) };
  }
  function c(k, _, T) {
    if (_ < 2)
    ...
    for (x.forEach((R) => {
      ...
      for (let I = A; I < x.length; I++) {
        const D = x[I], U = _ * R + D;
        if (!Number.isSafeInteger(U) || _ * R / _ !== R || U - D !== _ * R)
          throw new Error("convertRadix: carry overflow");
        if (R = U % T, x[I] = Math.floor(U / T), !Number.isSafeInteger(x[I]) || x[I] * T + R !== U)
          throw new Error("convertRadix: carry overflow");
        if (N)
          x[I] ? N = !1 : A = I;
        else continue;
    ...
    for (let R = 0; R < k.length - 1 && k[R] === 0; R++)
      v.push(0);
    return v.reverse();
  }
  const l = (k, _) => _ ? l(_, k % _) : k, u = (k, _) => k + (_ - l(k, _));
  function f(k, _, T, A) {
    if (!Array.isArray(k))
      throw new Error("convertRadix2: data should be array");
    if (_ <= 0 || _ > 32)
    ...
    if (T <= 0 || T > 32)
      throw new Error(`convertRadix2: wrong to=${T}`);
    if (u(_, T) > 32)
      throw new Error(`convertRadix2: carry overflow from=${_} to=${T} carryBits=${u(_, T)}`);
    let v = 0, x = 0;
    const R = 2 ** T - 1, N = [];
    for (const I of k) {
      if (e(I), I >= 2 ** _)
      ...
      if (v = v << _ | I, x + _ > 32)
        throw new Error(`convertRadix2: carry overflow pos=${x} from=${_}`);
      for (x += _; x >= T; x -= T)
        N.push((v >> x - T & R) >>> 0);
      v &= 2 ** x - 1;
    }
    ...
    return e(k), {
      encode: (_) => {
        if (!(_ instanceof Uint8Array))
          throw new Error("radix.encode input should be Uint8Array");
        return c(Array.from(_), 2 ** 8, k);
      },
      decode: (_) => {
        if (!Array.isArray(_) || _.length && typeof _[0] != "number")
          throw new Error("radix.decode input should be array of strings");
        return Uint8Array.from(c(_, k, 2 ** 8));
      }
    };
  }
  function p(k, _ = !1) {
    if (e(k), k <= 0 || k > 32)
      throw new Error("radix2: bits should be in (0..32]");
    if (u(8, k) > 32 || u(k, 8) > 32)
      throw new Error("radix2: carry overflow");
    return {
      encode: (T) => {
        if (!(T instanceof Uint8Array))
          throw new Error("radix2.encode input should be Uint8Array");
        return f(Array.from(T), 8, k, !_);
      },
      decode: (T) => {
        if (!Array.isArray(T) || T.length && typeof T[0] != "number")
          throw new Error("radix2.decode input should be array of strings");
        return Uint8Array.from(f(T, k, 8, _));
      }
    };
  }
  function b(k) {
    ...
    return function(..._) {
      try {
        return k.apply(null, _);
      } catch {
      }
    };
  }
  function E(k, _) {
    if (e(k), typeof _ != "function")
      throw new Error("checksum fn should be function");
    return {
      encode(T) {
        if (!(T instanceof Uint8Array))
          throw new Error("checksum.encode: input should be Uint8Array");
        const A = _(T).slice(0, k), v = new Uint8Array(T.length + k);
        return v.set(T), v.set(A, T.length), v;
      },
      decode(T) {
        if (!(T instanceof Uint8Array))
          throw new Error("checksum.decode: input should be Uint8Array");
        const A = T.slice(0, -k), v = _(A).slice(0, k), x = T.slice(-k);
        for (let R = 0; R < k; R++)
          if (v[R] !== x[R])
  ...
  n.utils = { alphabet: r, chain: t, checksum: E, radix: h, radix2: p, join: s, padding: o }, n.base16 = t(p(4), r("0123456789ABCDEF"), s("")), n.base32 = t(p(5), r("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), o(5), s("")), n.base32hex = t(p(5), r("0123456789ABCDEFGHIJKLMNOPQRSTUV"), o(5), s("")), n.base32crockford = t(p(5), r("0123456789ABCDEFGHJKMNPQRSTVWXYZ"), s(""), a((k) => k.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1"))), n.base64 = t(p(6), r("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), o(6), s("")), n.base64url = t(p(6), r("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), o(6), s(""));
  const g = (k) => t(h(58), r(k), s(""));
  ...
  n.base58xmr = {
    encode(k) {
      let _ = "";
      for (let T = 0; T < k.length; T += 8) {
        const A = k.subarray(T, T + 8);
        _ += n.base58.encode(A).padStart(m[A.length], "1");
      }
      return _;
    },
    decode(k) {
      let _ = [];
      for (let T = 0; T < k.length; T += 11) {
        const A = k.slice(T, T + 11), v = m.indexOf(A.length), x = n.base58.decode(A);
        for (let R = 0; R < x.length - v; R++)
          if (x[R] !== 0)
            throw new Error("base58xmr: wrong padding");
        _ = _.concat(Array.from(x.slice(x.length - v)));
      }
      return Uint8Array.from(_);
    }
  };
  const w = (k) => t(E(4, (_) => k(k(_))), n.base58);
  n.base58check = w;
  ...
  function M(k, _, T = 1) {
    ...
    let v = 1;
    for (let x = 0; x < A; x++) {
      const R = k.charCodeAt(x);
      if (R < 33 || R > 126)
        throw new Error(`Invalid prefix (${k})`);
      v = P(v) ^ R >> 5;
    }
    v = P(v);
    for (let x = 0; x < A; x++)
      v = P(v) ^ k.charCodeAt(x) & 31;
    for (let x of _)
      v = P(v) ^ x;
    for (let x = 0; x < 6; x++)
      v = P(v);
    return v ^= T, $.encode(f([v % 2 ** 30], 30, 5, !1));
  }
  function C(k) {
    const _ = k === "bech32" ? 1 : 734539939, T = p(5), A = T.decode, v = T.encode, x = b(A);
    function R(U, H, z = 90) {
      if (typeof U != "string")
        throw new Error(`bech32.encode prefix should be string, not ${typeof U}`);
      if (!Array.isArray(H) || H.length && typeof H[0] != "number")
        throw new Error(`bech32.encode words should be array of numbers, not ${typeof H}`);
      const V = U.length + 7 + H.length;
      if (z !== !1 && V > z)
        throw new TypeError(`Length ${V} exceeds limit ${z}`);
      return U = U.toLowerCase(), `${U}1${$.encode(H)}${M(U, H, _)}`;
    }
    function N(U, H = 90) {
      if (typeof U != "string")
        throw new Error(`bech32.decode input should be string, not ${typeof U}`);
      if (U.length < 8 || H !== !1 && U.length > H)
        throw new TypeError(`Wrong string length: ${U.length} (${U}). Expected (8..${H})`);
      const z = U.toLowerCase();
      if (U !== z && U !== U.toUpperCase())
        throw new Error("String must be lowercase or uppercase");
      U = z;
      const V = U.lastIndexOf("1");
      if (V === 0 || V === -1)
        throw new Error('Letter "1" must be present between prefix and data only');
      const W = U.slice(0, V), j = U.slice(V + 1);
      if (j.length < 6)
        throw new Error("Data must be at least 6 characters long");
      const G = $.decode(j).slice(0, -6), Z = M(W, G, _);
      if (!j.endsWith(Z))
        throw new Error(`Invalid checksum in ${U}: expected "${Z}"`);
      return { prefix: W, words: G };
    }
    const I = b(N);
    function D(U) {
      const { prefix: H, words: z } = N(U, !1);
      return { prefix: H, words: z, bytes: A(z) };
    }
    return { encode: R, decode: N, decodeToBytes: D, decodeUnsafe: I, fromWords: A, fromWordsUnsafe: x, toWords: v };
  }
  n.bech32 = C("bech32"), n.bech32m = C("bech32m"), n.utf8 = {
    encode: (k) => new TextDecoder().decode(k),
    decode: (k) => new TextEncoder().encode(k)
  }, n.hex = t(p(4), r("0123456789abcdef"), s(""), a((k) => {
    if (typeof k != "string" || k.length % 2)
      throw new TypeError(`hex.decode: expected string, got ${typeof k} with length ${k.length}`);
  ...
  }, L = `Invalid encoding type. Available types: ${Object.keys(S).join(", ")}`, F = (k, _) => {
    if (typeof k != "string" || !S.hasOwnProperty(k))
      throw new TypeError(L);
    if (!(_ instanceof Uint8Array))
      throw new TypeError("bytesToString() expects Uint8Array");
    return S[k].encode(_);
  };
  n.bytesToString = F, n.str = n.bytesToString;
  const O = (k, _) => {
  ...
  n.stringToBytes = O, n.bytes = n.stringToBytes;
})(lib);
...
function chooseRelayCombinationForPubkeys(n, e, t, { count: r, preferredRelays: s } = {}) {
  ...
  const c = /* @__PURE__ */ new Map(), { pubkeysToRelays: l, authorsMissingRelays: u } = getAllRelaysForAllPubkeys(n, e, t), f = getTopRelaysForAuthors(n, e), h = (p, b) => {
    const E = c.get(b) || [];
    E.push(p), c.set(b, E);
  };
  for (const [p, b] of l.entries()) {
    let E = r;
    for (const g of a)
      b.has(g.url) && (h(p, g.url), E--);
    for (const g of b)
      c.has(g) && (h(p, g), E--);
    if (!(E <= 0))
      for (const g of f) {
  ...
  for (const p of u)
    o.permanentAndConnectedRelays().forEach((b) => {
      const E = c.get(b.url) || [];
      E.push(p), c.set(b.url, E);
    });
  return c;
}
...
var DATA_URL_DEFAULT_MIME_TYPE = "text/plain", DATA_URL_DEFAULT_CHARSET = "us-ascii", testParameter = (n, e) => e.some((t) => t instanceof RegExp ? t.test(n) : t === n), supportedProtocols = /* @__PURE__ */ new Set(["https:", "http:", "file:"]), hasCustomProtocol = (n) => {
  ...
  const r = ((h = t.groups) == null ? void 0 : h.type) ?? "", s = ((p = t.groups) == null ? void 0 : p.data) ?? "";
  let o = ((b = t.groups) == null ? void 0 : b.hash) ?? "";
  const a = r.split(";");
  o = e ? "" : o;
  let c = !1;
  a[a.length - 1] === "base64" && (a.pop(), c = !0);
  const l = ((E = a.shift()) == null ? void 0 : E.toLowerCase()) ?? "", f = [...a.map((g) => {
    let [m, w = ""] = g.split("=").map(($) => $.trim());
    return m === "charset" && (w = w.toLowerCase(), w === DATA_URL_DEFAULT_CHARSET) ? "" : `${m}${w ? `=${w}` : ""}`;
  }).filter(Boolean)];
  return c && f.push("base64"), (f.length > 0 || l && l !== DATA_URL_DEFAULT_MIME_TYPE) && f.unshift(l), `data:${f.join(";")},${c ? s.trim() : s}${o ? `#${o}` : ""}`;
};
function normalizeUrl(n, e = {}) {
  ...
  if (e.forceHttp && s.protocol === "https:" && (s.protocol = "http:"), e.forceHttps && s.protocol === "http:" && (s.protocol = "https:"), e.stripAuthentication && (s.username = "", s.password = ""), e.stripHash ? s.hash = "" : e.stripTextFragment && (s.hash = s.hash.replace(/#?:~:text.*?$/i, "")), s.pathname) {
    ...
    let c = 0, l = "";
    for (; ; ) {
      const f = a.exec(s.pathname);
      if (!f)
        break;
      const h = f[0], p = f.index, b = s.pathname.slice(c, p);
      l += b.replace(/\/{2,}/g, "/"), l += h, c = p + h.length;
    }
...
var MAX_RECONNECT_ATTEMPTS = 5, FLAPPING_THRESHOLD_MS = 1e3, NDKRelayConnectivity = class {
  ...
  async publish(n, e = 2500) {
    ...
    const r = () => new Promise((f, h) => {
      try {
        this.publishEvent(n).then((p) => {
          this.ndkRelay.emit("published", n), n.emit("relay:published", this.ndkRelay), f(!0);
        }).catch(h);
      } catch (p) {
        h(p);
      }
      ...
      t = setTimeout(() => {
        t = void 0, h(new Error(`Timeout: ${e}ms`));
      }, e);
    }), o = () => {
      r().then((f) => a(f)).catch((f) => c(f));
    };
    let a, c;
    const l = (f) => {
      throw this.ndkRelay.debug("Publish failed", f, n.id), this.ndkRelay.emit("publish:failed", n, f), n.emit("relay:publish:failed", this.ndkRelay, f), f;
    }, u = () => {
    ...
    return this.ndkRelay.status >= 5 ? Promise.race([r(), s]).catch(l).finally(u) : (this.ndkRelay.status <= 1 ? (console.warn("Relay is disconnected, trying to connect to publish an event", this.ndkRelay.url), this.ndkRelay.connect()) : console.warn("Relay not connected, waiting for connection to publish an event", this.ndkRelay.url), Promise.race([
      new Promise((f, h) => {
        a = f, c = h, this.ndkRelay.once("connect", o);
      }),
      s
    ]).catch(l).finally(u));
  }
...
}, me, NDKRelay = (me = class extends lib$1.EventEmitter {
  constructor(t, r, s) {
    super();
    y(this, "url");
    y(this, "scores");
...
}, y(me, "defaultValidationRatioUpdateFn", (t, r, s) => {
...
}), me), NDKPublishError = class extends Error {
  constructor(e, t, r, s) {
    super(e);
    y(this, "errors");
...
`);
  ...
  async publish(e, t, r = 1) {
    ...
    try {
      const u = Array.from(this.relays).map((f) => new Promise((h) => {
        const p = t ? setTimeout(() => {
          s.has(f) || (o.set(f, new Error(`Publish timeout after ${t}ms`)), h(!1));
        }, t) : null;
        f.publish(e, t).then((b) => {
          p && clearTimeout(p), b ? (s.add(f), h(!0)) : h(!1);
        }).catch((b) => {
          p && clearTimeout(p), a || o.set(f, b), h(!1);
        });
      }));
      if (await Promise.all(u), s.size < r) {
        if (!a) {
          const f = new NDKPublishError(
            "Not enough relays received the event",
            o,
            s,
            this
          );
          throw e.publishStatus = "error", e.publishError = f, (l = this.ndk) == null || l.emit("event:publish-failed", e, f, this.relayUrls), f;
        }
      } else
...
async function calculateRelaySetFromEvent(n, e) {
  ...
  return o.length < 5 ? Array.from(
    ...
    var f;
    const u = (f = n.pool) == null ? void 0 : f.getRelay(l, !1, !0);
    ...
    try {
      ...
      switch (l) {
        ...
        case "note":
          r.push(
            new Promise(async (h) => {
              s(["q", u, await maybeGetEventRelayUrl(c)]), h();
            })
          );
          break;
        case "nevent":
          r.push(
            new Promise(async (h) => {
              const { id: p, author: b } = u;
              let { relays: E } = u;
              (!E || E.length === 0) && (E = [await maybeGetEventRelayUrl(c)]), s(["q", p, E[0]]), b && s(["p", b]), h();
            })
          );
          break;
        case "naddr":
          r.push(
            new Promise(async (h) => {
              ...
              let b = u.relays ?? [];
              b.length === 0 && (b = [await maybeGetEventRelayUrl(c)]), s(["q", p, b[0]]), s(["p", u.pubkey]), h();
            })
          );
          break;
        default:
...
async function decrypt(n, e, t) {
  ...
  if ((l = (c = this.ndk) == null ? void 0 : c.cacheAdapter) != null && l.getDecryptedEvent) {
    let h = null;
    if (typeof this.ndk.cacheAdapter.getDecryptedEvent == "function" && (h = this.ndk.cacheAdapter.getDecryptedEvent(this.id)), h) {
  ...
  this.content = r, (f = (u = this.ndk) == null ? void 0 : u.cacheAdapter) != null && f.addDecryptedEvent && this.ndk.cacheAdapter.addDecryptedEvent(this);
}
...
var skipClientTagOnKinds = /* @__PURE__ */ new Set([
  ...
  5
  /* EventDeletion */
]), NDKEvent = class be extends lib$1.EventEmitter {
  constructor(t, r) {
    var s;
    super();
    y(this, "ndk");
    ...
    this.ndk = t, this.created_at = r == null ? void 0 : r.created_at, this.content = (r == null ? void 0 : r.content) || "", this.tags = (r == null ? void 0 : r.tags) || [], this.id = (r == null ? void 0 : r.id) || "", this.sig = r == null ? void 0 : r.sig, this.pubkey = (r == null ? void 0 : r.pubkey) || "", this.kind = r == null ? void 0 : r.kind, r instanceof be && (this.relay && (this.relay = r.relay, (s = this.ndk) == null || s.subManager.seenEvent(r.id, this.relay)), this.publishStatus = r.publishStatus, this.publishError = r.publishError);
  }
  /**
  ...
  tag(t, r, s, o) {
    ...
    if (t.fetchProfile !== void 0) {
      ...
      for (const u of l.getMatchingTags("p"))
        u[1] !== this.pubkey && (this.tags.find((f) => f[0] === "p" && f[1] === u[1]) || this.tags.push(["p", u[1]]));
  ...
  async publish(t, r, s) {
    ...
    if ((!t || t.size === 0) && (t = this.ndk.devWriteRelaySet || await calculateRelaySetFromEvent(this.ndk, this)), this.kind === 5 && ((c = this.ndk.cacheAdapter) != null && c.deleteEventIds)) {
      const f = this.getMatchingTags("e").map((h) => h[1]);
      this.ndk.cacheAdapter.deleteEventIds(f);
    }
    ...
    if ((l = this.ndk.cacheAdapter) != null && l.addUnpublishedEvent && shouldTrackUnpublishedEvent(this))
      try {
        ...
        console.error("Error adding unpublished event to cache", f);
      }
    this.kind === 5 && ((u = this.ndk.cacheAdapter) != null && u.deleteEventIds) && this.ndk.cacheAdapter.deleteEventIds(this.getMatchingTags("e").map((f) => f[1])), this.ndk.subManager.dispatchEvent(o, void 0, !0);
    const a = await t.publish(this, r, s);
    return a.forEach((f) => {
      var h;
      return (h = this.ndk) == null ? void 0 : h.subManager.seenEvent(this.id, f);
    }), a;
  }
  /**
  ...
  async generateTags() {
    ...
    if (t = r.tags, this.kind && this.isParamReplaceable() && !this.getMatchingTags("d")[0]) {
      ...
      let h = [...Array(u ? 6 : 16)].map(() => Math.random().toString(36)[2]).join("");
      u && u.length > 0 && (h = `${u.replace(/[^a-z0-9]+/gi, "-").replace(/^-|-$/g, "")}-${h}`), t.push(["d", h]);
    }
  ...
  reply() {
    ...
    if (this.kind === 1)
      ...
      if (a.length > 0) {
        ...
        const [l, u, f, ...h] = this.tagReference(), p = [l, u, ...h];
        t.tags.push(p);
      } else {
        const [c, l, u, f] = this.tagReference(), h = [c, l, f ?? ""];
        c === "e" && h.push(this.pubkey), t.tags.push(h);
        const p = [...h];
...
var NDKPool = class extends lib$1.EventEmitter {
  ...
  addRelay(e, t = !0) {
    ...
    if ((m = this.ndk.cacheAdapter) != null && m.getRelayStatus) {
    ...
    const l = (w) => this.emit("notice", e, w), u = () => this.handleRelayConnect(c), f = () => this.handleRelayReady(e), h = () => this.emit("relay:disconnect", e), p = () => this.handleFlapping(e), b = (w) => this.emit("relay:auth", e, w), E = () => this.emit("relay:authed", e);
    e.off("notice", l), e.off("connect", u), e.off("ready", f), e.off("disconnect", h), e.off("flapping", p), e.off("auth", b), e.off("authed", E), e.on("notice", l), e.on("connect", u), e.on("ready", f), e.on("disconnect", h), e.on("flapping", p), e.on("auth", b), e.on("authed", E), e.on("delayed-connect", (w) => {
      var $;
    ...
    for (const o of r) {
      ...
      if (e) {
        const l = new Promise((u, f) => {
          setTimeout(() => f(`Timed out after ${e}ms`), e);
        });
        t.push(
...
}, ie, NDKCashuMintList = (ie = class extends NDKEvent {
  constructor(t, r) {
    super(t, r);
    y(this, "_p2pk");
...
}, y(ie, "kind", 10019), y(ie, "kinds", [
  10019
  /* CashuMintList */
]), ie), oe, NDKArticle = (oe = class extends NDKEvent {
  constructor(e, t) {
...
var ae, NDKCashuToken = (ae = class extends NDKEvent {
  constructor(t, r) {
    super(t, r);
    y(this, "_proofs", []);
    y(this, "_mint");
...
}, y(ae, "kind", 7375), y(ae, "kinds", [
  7375
  /* CashuToken */
]), ae), ce, NDKHighlight = (ce = class extends NDKEvent {
  constructor(t, r) {
    super(t, r);
    y(this, "_article");
...
var le, NDKImage = (le = class extends NDKEvent {
  constructor(t, r) {
    super(t, r);
    y(this, "_imetas");
   ...
   */
  static from(t) {
    return new le(t.ndk, t.rawEvent());
  }
  get isValid() {
...
}, y(le, "kind", 20), y(le, "kinds", [
  20
  /* Image */
]), le), we, NDKList = (we = class extends NDKEvent {
  constructor(t, r) {
    super(t, r);
  ...
  10003
  /* BookmarkList */
]), we), lists_default = NDKList, ne, NDKNutzap = (ne = class extends NDKEvent {
  constructor(t, r) {
    super(t, r);
    y(this, "debug");
    y(this, "_proofs", []);
...
}, y(ne, "kind", 9321), y(ne, "kinds", [ne.kind]), ne), he, NDKSimpleGroupMemberList = (he = class extends NDKEvent {
  constructor(t, r) {
    super(t, r);
    y(this, "relaySet");
...
}, y(he, "kind", 39002), y(he, "kinds", [
  39002
  /* GroupMembers */
]), he), ue, NDKSimpleGroupMetadata = (ue = class extends NDKEvent {
  constructor(e, t) {
...
}, y(Q, "Text", "text"), y(Q, "Pubkey", "pubkey"), y(Q, "Event", "event"), y(Q, "Prompt", "prompt"), y(Q, "Countdown", "countdown"), Q), de, NDKStory = (de = class extends NDKEvent {
  constructor(t, r) {
    super(t, r);
    y(this, "_imeta");
    y(this, "_dimensions");
...
}, y(de, "kind", 23), y(de, "kinds", [
  23
  /* Story */
]), de), coordinates = (n) => `${n.x},${n.y}`, dimension = (n) => `${n.width}x${n.height}`, possibleIntervalFrequencies = [
  "daily",
  "weekly",
  "monthly",
  "quarterly",
...
var pe, NDKSubscriptionTier = (pe = class extends NDKArticle {
  constructor(e, t) {
...
}, y(pe, "kind", 37001), y(pe, "kinds", [
  37001
  /* SubscriptionTier */
]), pe), ye, NDKVideo = (ye = class extends NDKEvent {
  constructor() {
    super(...arguments);
    y(this, "_imetas");
  }
   ...
   */
  static from(t) {
    return new ye(t.ndk, t.rawEvent());
  }
  /**
   * Getter for the article title.
   *
...
}, y(ye, "kind", 21), y(ye, "kinds", [
  34235,
  34236,
  22,
  21
  /* Video */
]), ye), Ee, NDKWiki = (Ee = class extends NDKArticle {
}, y(Ee, "kind", 30818), y(Ee, "kinds", [
  30818
  /* Wiki */
]), Ee);
...
var defaultOpts = {
  ...
  eventReceived(e, t, r = !1, s = !1) {
    ...
    if (e instanceof NDKEvent && (c = e), a) {
      ...
      if (this.emit("event:dup", e, t, u, this, r, s), t) {
        const f = verifiedSignatures.get(o);
        f && typeof f == "string" && e.sig === f && t.addValidatedEvent();
      }
    } else {
  ...
  eoseReceived(e) {
    ...
    if (s || r)
      ...
      let c = 1e3;
      const l = new Set(this.pool.connectedRelays().map((h) => h.url)), u = Array.from(this.relayFilters.keys()).filter(
        (h) => l.has(h)
      );
      if (u.length === 0) {
        this.debug(
      ...
      const f = this.eosesSeen.size / u.length;
      if (this.debug("Percentage of relays that have sent EOSE", {
        subId: this.subId,
        percentageOfRelaysThatHaveSentEose: f,
        seen: this.eosesSeen.size,
        total: u.length
      }), this.eosesSeen.size >= 2 && f >= 0.5) {
        if (c = c * (1 - f), c === 0) {
        ...
        const h = () => {
          t = this.lastEventReceivedAt ? Date.now() - this.lastEventReceivedAt : void 0, t !== void 0 && t < 20 ? this.eoseTimeout = setTimeout(h, c) : o(`send eose timeout: ${c}`);
        };
        this.eoseTimeout = setTimeout(h, c);
      }
    }
  }
  ...
  return await n.queuesNip05.add({
    ...
    func: async () => {
      ...
      if ((l = n.cacheAdapter) != null && l.loadNip05) {
        const h = await n.cacheAdapter.loadNip05(e);
        if (h !== "missing") {
          if (h) {
            const p = new NDKUser({
              pubkey: h.pubkey,
      ...
      const [o, a = "_", c] = s;
      try {
        const h = await t(`https://${c}/.well-known/nostr.json?name=${a}`, r), { names: p, relays: b, nip46: E } = parseNIP05Result(await h.json()), g = p[a.toLowerCase()];
        let m = null;
        return g && (m = { pubkey: g, relays: b == null ? void 0 : b[g], nip46: E == null ? void 0 : E[g] }), (u = n == null ? void 0 : n.cacheAdapter) != null && u.saveNip05 && n.cacheAdapter.saveNip05(e, m), m;
      } catch (h) {
        return (f = n == null ? void 0 : n.cacheAdapter) != null && f.saveNip05 && (n == null || n.cacheAdapter.saveNip05(e, null)), console.error("Failed to fetch NIP05 for", e, h), null;
      }
    }
  });
}
...
var NDKUser = class Se {
  ...
  async getZapInfo(e) {
    ...
    const t = async (a) => {
      ...
      let c;
      const l = new Promise((u, f) => {
        c = setTimeout(() => f(new Error("Timeout")), e);
      });
      try {
...
}, READ_MARKER = "read", WRITE_MARKER = "write", NDKRelayList = class Ce extends NDKEvent {
  constructor(e, t) {
    super(e, t), this.kind ?? (this.kind = 10002);
  }
  static from(e) {
    return new Ce(e.ndk, e.rawEvent());
  }
  get readRelayUrls() {
...
var NDKPrivateKeySigner = class xe {
  /**
...
var NDKRelayAuthPolicies = {
  ...
  async processEncryptionQueue(e, t = 0) {
    ...
    try {
      const p = await ((h = (f = window.nostr) == null ? void 0 : f[s]) == null ? void 0 : h[o](a, c));
      if (!p) throw new Error("Failed to encrypt/decrypt");
      l(p);
    } catch (p) {
      const b = p instanceof Error ? p.message : String(p);
      if (b.includes("call already executing") && t < 5) {
      ...
      u(p instanceof Error ? p : new Error(b));
    }
  ...
  async parseEvent(e) {
    ...
    try {
      ...
      const h = this.encryptionType === "nip04" ? "nip44" : "nip04";
      r = await this.signer.decrypt(t, e.content, h), this.encryptionType = h;
    }
  ...
  async sendRequest(e, t, r = [], s = 24133, o) {
    const a = Math.random().toString(36).substring(7), c = await this.signer.user(), l = this.ndk.getUser({ pubkey: e }), u = { id: a, method: t, params: r }, f = new Promise(() => {
      const p = (b) => {
        b.result === "auth_url" ? (this.once(`response-${a}`, p), this.emit("authUrl", b.error)) : o && o(b);
      };
      this.once(`response-${a}`, p);
    }), h = new NDKEvent(this.ndk, {
      kind: s,
      content: JSON.stringify(u),
      tags: [["p", e]],
      pubkey: c.pubkey
    });
    return h.content = await this.signer.encrypt(l, h.content, this.encryptionType), await h.sign(this.signer), await h.publish(this.relaySet), f;
  }
...
var NDKNip46Signer = class ke extends lib$1.EventEmitter {
  /**
   * @param ndk - The NDK instance to use
  ...
  static async fromPayload(t, r) {
    ...
    let c;
    return o.nip05 ? (c = new ke(r, o.nip05, a), c.userPubkey = o.userPubkey, c.bunkerPubkey = o.bunkerPubkey, c.relayUrls = o.relayUrls, c.secret = o.secret) : (c = new ke(r, o.userPubkey, a), c.bunkerPubkey = o.bunkerPubkey, c.relayUrls = o.relayUrls, c.secret = o.secret), c;
  }
};
function dedup(n, e) {
...
async function getRelayListForUsers(n, e, t = !1, r = 1e3) {
  ...
  if ((h = e.cacheAdapter) != null && h.locking && !t) {
    const p = await e.fetchEvents(
      { kinds: [3, 10002], authors: Array.from(new Set(n)) },
      { cacheUsage: "ONLY_CACHE", subId: "ndk-relay-list-fetch" }
    );
    for (const b of p)
      b.kind === 10002 && a.set(b.pubkey, NDKRelayList.from(b));
    for (const b of p)
      if (b.kind === 3) {
        if (a.has(b.pubkey)) continue;
        const E = relayListFromKind3(e, b);
        E && c.set(b.pubkey, E);
      }
    n = n.filter((b) => !a.has(b) && !c.has(b));
  }
  ...
  return new Promise((p) => {
    (async () => {
      ...
      l && (E.relaySet = l), e.subscribe({ kinds: [3, 10002], authors: n }, E, {
        onEvent: (g) => {
          if (g.kind === 10002) {
            const m = u.get(g.pubkey);
            if (m && m.created_at > g.created_at) return;
            u.set(g.pubkey, g);
          } else if (g.kind === 3) {
            const m = f.get(g.pubkey);
            if (m && m.created_at > g.created_at) return;
            f.set(g.pubkey, g);
          }
        },
        onEose: () => {
          ...
          for (const g of n) {
            ...
            const m = f.get(g);
            if (!m) continue;
            const w = relayListFromKind3(e, m);
            w && a.set(g, w);
          }
          p(a);
        }
        ...
        r.push(
          new Promise((c) => {
            getRelayListForUsers(a, this.ndk, t).then((l) => {
              for (const [u, f] of l) {
                let h = this.data.get(u);
                if (h ?? (h = new OutboxItem("user")), f) {
                  h.readRelays = new Set(normalize(f.readRelayUrls)), h.writeRelays = new Set(normalize(f.writeRelayUrls));
...
async function fetchEventFromTag(n, e, t, r = {
  ...
  if (l && l.size > 0) {
    ...
    const g = NDKRelaySet.fromRelayUrls(Array.from(l), this), m = await this.fetchEvent(a, t, g);
    if (m) return m;
  } else
  ...
  const f = await this.fetchEvent(a, t);
  if (f) return f;
  if (c && c !== "") {
  ...
  let h;
  const p = isValidHint(c) ? this.pool.getRelay(c, !1, !0, [{ ids: [a] }]) : void 0, b = new Promise((g) => {
    this.fetchEvent(a, t, p).then(g);
  });
  if (!isValidHint(c) || r.type === "none")
    return b;
  const E = new Promise(async (g) => {
    const m = r.relaySet, w = r.timeout ?? 1500, $ = new Promise((B) => setTimeout(B, w));
    if (r.type === "timeout" && await $, h)
      g(h);
    else {
      s("fallback fetch triggered");
      const B = await this.fetchEvent(a, t, m);
      g(B);
    }
  });
  switch (r.type) {
    case "timeout":
      return Promise.race([b, E]);
    case "eose":
      return h = await b, h || E;
  }
}
var Queue = class {
  constructor(n, e) {
  ...
  async fetchEvent(e, t, r) {
    ...
    return new Promise((a) => {
      ...
      u.on("event", (h) => {
        h.ndk = this, h.isReplaceable() ? (!c || c.created_at < h.created_at) && (c = h) : (clearTimeout(f), a(h));
      }), u.on("eose", () => {
        clearTimeout(f), a(c);
      }), u.start();
    });
  ...
  async fetchEvents(e, t, r) {
    return new Promise((s) => {
      ...
      const c = this.subscribe(
        ...
        let f;
        u instanceof NDKEvent ? f = u : f = new NDKEvent(void 0, u);
        const h = f.deduplicationKey(), p = o.get(h);
        p && (f = dedup(p, f)), f.ndk = this, o.set(h, f);
      };
...
async function getPostStats(n, e) {
  const t = await n.fetchEvents({
    ...
    "#e": [e || ""]
  }), r = Array.from(t).filter((l) => l.tags.filter((f) => f[0] === "p").length === 1).length, s = await n.fetchEvents({
    kinds: [NDKKind.Reaction],
    "#e": [e || ""]
  }), o = 0, a = await n.fetchEvents({
    kinds: [NDKKind.Text],
    "#e": [e || ""]
  }), c = Array.from(a).filter((l) => l.tags.filter((f) => f[0] === "e").length === 1).length;
  return {
    likes: s.size,
    reposts: r,
...
class NostrPost extends HTMLElement {
  constructor() {
    super(...arguments);
    Te(this, re);
    this.rendered = !1, this.ndk = new NDK(), this.isLoading = !0, this.isError = !1, this.theme = "light", this.post = null, this.stats = null, this.embeddedPosts = /* @__PURE__ */ new Map(), this.receivedData = !1, this.author = {
      name: "",
      image: "",
      nip05: ""
    }, this.onClick = null, this.onAuthorClick = null, this.onMentionClick = null, this.connectToNostr = async () => {
      await this.ndk.connect();
    }, this.getRelays = () => {
      ...
      for (const o of t)
        if (o.type === "text")
          s += o.value;
        else if (o.type === "embedded-note")
          s && (r.push(`<span class="text-content">${s.replace(/\n/g, "<br />")}</span>`), s = ""), r.push(`<div class="embedded-post-placeholder" data-note-id="${o.noteId}"></div>`);
        else
          switch (s && (r.push(`<span class="text-content">${s.replace(/\n/g, "<br />")}</span>`), s = ""), o.type) {
            case "image":
              r.push(`<img width="100%" src="${o.value}" alt="Image">`);
              break;
            case "gif":
              r.push(`<img width="100%" src="${o.value}" alt="GIF">`);
              break;
            case "video":
              r.push(`<video width="100%" src="${o.value}" controls></video>`);
              break;
            case "link":
              r.push(`<a href="${o.value}">${o.value}</a>`);
              break;
          }
      return s && r.push(`<span class="text-content">${s.replace(/\n/g, "<br />")}</span>`), r.join("");
    };
  }
  async connectedCallback() {
    ...
    r !== null && (this.onAuthorClick = window[r]);
    const s = this.getAttribute("onMentionClick");
    s !== null && (this.onMentionClick = window[s]), this.render(), this.rendered || (this.ndk = new NDK({
      explicitRelayUrls: this.getRelays()
  ...
  attributeChangedCallback(t, r, s) {
    t === "relays" && (this.ndk.explicitRelayUrls = this.getRelays(), this.connectToNostr()), ["relays", "id"].includes(t) && this.getPost(), t === "onClick" && (this.onClick = window[s]), t === "onAuthorClick" && (this.onAuthorClick = window[s]), t === "onMentionClick" && (this.onMentionClick = window[s]), t === "theme" && (this.getTheme(), this.render()), t === "show-stats" && this.render();
  }
  async getPost() {
    var t;
    try {
  ...
  async parseText(t) {
    let r = t, s = [];
    const o = /(nostr:)?(note[a-zA-Z0-9]{59,60})/g, a = [...r.matchAll(o)];
    for (const b of a) {
      const E = b[0], g = b[2], m = b.index || 0;
      s.push({
        id: g,
        position: m
      });
      try {
        if (!this.embeddedPosts.has(g)) {
          const w = await this.ndk.fetchEvent(g);
          w && this.embeddedPosts.set(g, w);
        }
      } catch (w) {
        console.error(`Failed to fetch embedded post ${g}:`, w);
      }
      r = r.replace(E, "");
    }
    const c = r.matchAll(new RegExp(nip21_exports.NOSTR_URI_REGEX, "g"));
    for (let b of c) {
      const E = nip21_exports.parse(b[0]), g = E.decoded.data;
      let m = "";
      typeof g == "string" ? m = g : m = g.pubkey;
      const w = await this.ndk.getUser({ pubkey: m }).fetchProfile(), $ = (w == null ? void 0 : w.displayName) || "";
      r = r.replace(b[0], `<a href="https://njump.me/${E.value}" target="_blank">@${$}</a>`);
    }
    const l = /(\s|^)@(\w+)/g, u = [...r.matchAll(l)];
    for (const b of u) {
      const E = b[0], g = b[2];
      r = r.replace(
        E,
        `${b[1]}<span class="nostr-mention" data-username="${g}">@${g}</span>`
      );
    }
    const f = /(https:\/\/(?!njump\.me)[\w.-]+(?:\.[\w.-]+)+(?:\/[^\s]*)?)/g, h = r.match(f), p = [];
    if (h) {
      let b = 0;
      for (const E of h) {
        const g = r.indexOf(E, b), m = g + E.length;
        g > b && p.push({ type: "text", value: r.substring(b, g) });
        const w = new URL(E);
        let $;
        w.pathname.endsWith(".jpg") || w.pathname.endsWith(".jpeg") || w.pathname.endsWith(".png") ? $ = "image" : w.pathname.endsWith(".gif") ? $ = "gif" : w.pathname.endsWith(".mp4") || w.pathname.endsWith(".webm") ? $ = "video" : $ = "link", p.push({ type: $, value: E }), b = m;
      }
      b < r.length && p.push({ type: "text", value: r.substring(b) });
    } else
      p.push({ type: "text", value: r });
    if (s.length > 0) {
      s.sort((b, E) => E.position - b.position);
      for (const b of s)
        p.push({
          type: "embedded-note",
          noteId: b.id
  ...
  async replaceEmbeddedPostPlaceholders() {
    var r;
    const t = this.querySelectorAll(".embedded-post-placeholder");
    for (const s of t) {
      const o = s.getAttribute("data-note-id");
      if (o) {
        const a = await this.renderEmbeddedPost(o), c = document.createElement("div");
        c.innerHTML = a, (r = s.parentNode) == null || r.replaceChild(c.firstElementChild, s);
        const l = c.firstElementChild, u = l == null ? void 0 : l.querySelector(".embedded-author-avatar"), f = l == null ? void 0 : l.querySelector(".embedded-author-info");
        if (l && u && f) {
          const h = l.getAttribute("data-note-id");
          if (h && this.embeddedPosts.has(h)) {
            const b = this.embeddedPosts.get(h).author.npub, E = (g) => {
              g.preventDefault(), g.stopPropagation(), window.open(`https://njump.me/${b}`, "_blank");
            };
            u.addEventListener("click", E), f.addEventListener("click", E);
          }
        }
      }
    }
  }
  async renderEmbeddedPost(t) {
    if (!this.embeddedPosts.has(t))
      return '<div class="embedded-post-error">Unable to load embedded post</div>';
    const r = this.embeddedPosts.get(t);
    let s = null;
    try {
      s = await r.author.fetchProfile();
    } catch (b) {
      console.error("Failed to fetch author profile for embedded post:", b);
    }
    const o = new Date(r.created_at * 1e3).toLocaleDateString("en-US", {
      month: "short",
      day: "numeric",
      year: "numeric"
    });
    let a = "", c = "", l = [];
    const u = /(https:\/\/[\w.-]+(?:\.[\w.-]+)+(?:\/[^\s]*)?)/g, f = r.content.match(u);
    let h = r.content;
    if (f)
      for (const b of f)
        try {
          b.match(/\.(jpeg|jpg|gif|png)$/i) ? (l.push({ type: "image", url: b }), h = h.replace(b, " ")) : b.match(/\.(mp4|webm)$/i) && (l.push({ type: "video", url: b }), h = h.replace(b, " "));
        } catch (E) {
          console.error("Error processing URL in embedded post:", E);
        }
    let p = h.trim();
    if (p.length > 280 && (p = p.substring(0, 277) + "..."), a = p.replace(/\n/g, "<br>"), l.length > 0) {
      c = '<div class="embedded-media-list">';
      for (const b of l)
        b.type === "image" ? c += `<div class="embedded-media-item"><img src="${b.url}" alt="Embedded image" loading="lazy" /></div>` : b.type === "video" && (c += `<div class="embedded-media-item"><video src="${b.url}" controls preload="none"></video></div>`);
      c += "</div>";
    }
    return `
      <div class="embedded-post" data-note-id="${t}">
        <div class="embedded-post-header">
          <div class="embedded-author-avatar" style="cursor: pointer;">
            ${s != null && s.image ? `<img src="${s.image}" alt="Profile">` : ""}
          </div>
          <div class="embedded-author-info" style="cursor: pointer;">
            <span class="embedded-author-name">${(s == null ? void 0 : s.displayName) || "Unknown"}</span>
            ${s != null && s.nip05 ? `<span class="embedded-author-username">${s.nip05}</span>` : ""}
          </div>
          <div class="embedded-post-date">${o}</div>
        </div>
        <div class="embedded-post-content">
          ${a}
          ${c ? `<div class="embedded-post-media">${c}</div>` : ""}
        </div>
      </div>
    `;
  }
  setupMentionClickHandlers() {
    this.querySelectorAll(".nostr-mention").forEach((c) => {
      c.addEventListener("click", (l) => {
        var f;
        const u = c.getAttribute("data-username") || ((f = c.textContent) == null ? void 0 : f.slice(1));
        u && ve(this, re, Pe).call(this, u, l);
      });
    });
    const r = this.querySelector(".post-header-left"), s = this.querySelector(".post-header-middle");
    r && r.addEventListener("click", (c) => {
      c.preventDefault(), c.stopPropagation(), ve(this, re, _e).call(this);
    }), s && s.addEventListener("click", (c) => {
      c.preventDefault(), c.stopPropagation(), ve(this, re, _e).call(this);
    });
    const o = this.querySelector(".post-container");
    o && o.addEventListener("click", (c) => {
      (c.target === o || c.target.closest(".post-body") && !c.target.closest("a, .nostr-mention, video, img")) && ve(this, re, Le).call(this);
    }), this.querySelectorAll("a, video, img").forEach((c) => {
      c.addEventListener("click", (l) => {
        l.stopPropagation();
      });
    });
  ...
  async render() {
    var l, u, f, h, p, b;
    const t = ((l = this.post) == null ? void 0 : l.content) || "", r = await this.parseText(t), s = this.renderContent(r);
    let o = "";
        ...
        <div class="post-header">
          <div class="post-header-left">
            <div class="author-picture">
              ${this.isLoading ? '<div style="width: 35px; height: 35px; border-radius: 50%;" class="skeleton"></div>' : this.isError ? "" : `<img src="${(u = this.author) == null ? void 0 : u.image}" />`}
              </div>
          </div>
          <div class="post-header-middle">
            ${this.isLoading ? `
              ...
              ` : this.isError ? "" : `
                  ${(f = this.author) != null && f.displayName ? `<span class="author-name">${(h = this.author) == null ? void 0 : h.displayName}</span>` : ""}
                  ${(p = this.author) != null && p.nip05 ? `<span class="author-username">${(b = this.author) == null ? void 0 : b.nip05}</span>` : ""}
    ...
    `, await this.replaceEmbeddedPostPlaceholders(), this.setupMentionClickHandlers();
    const c = this.querySelector(".post-body");
    c && c.setAttribute("style", "cursor: pointer;");
  }
}
re = new WeakSet(), Le = function() {
  if (this.isError)
    return;
  if (this.onClick !== null && typeof this.onClick == "function") {
  ...
  const s = this.getAttribute("onMentionClick");
  if (s !== null && window[s] && typeof window[s] == "function") {
    window[s](t);
    return;
  }
  window.open(`https://njump.me/search?q=${encodeURIComponent("@" + t)}`, "_blank");
};
...
class NostrProfile extends HTMLElement {
  ...
  attachEventListeners() {
    ...
    (e = this.shadowRoot.querySelector(".nostr-profile")) == null || e.addEventListener("click", (s) => {
      !s.target.closest(".nostr-follow-button-container") && !s.target.closest(".website a") && this.onProfileClick();
