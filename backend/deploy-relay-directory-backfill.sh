...
FIRESTORE_GAPS_COLLECTION="${FIRESTORE_GAPS_COLLECTION:-relayCrawlerGaps}"
...
BACKFILL_MAX_PAGES="${BACKFILL_MAX_PAGES:-4}"
...
ENV_VARS="^@^GOOGLE_CLOUD_PROJECT=${PROJECT_ID}@FIRESTORE_PROJECT=${PROJECT_ID}@FIRESTORE_DATABASE=${FIRESTORE_DATABASE}@FIRESTORE_HANDLES_COLLECTION=${FIRESTORE_HANDLES_COLLECTION}@FIRESTORE_ENTRIES_COLLECTION=${FIRESTORE_ENTRIES_COLLECTION}@FIRESTORE_STATE_COLLECTION=${FIRESTORE_STATE_COLLECTION}@FIRESTORE_GAPS_COLLECTION=${FIRESTORE_GAPS_COLLECTION}@FIRESTORE_HANDLE_WRITE_FAILURES_COLLECTION=${FIRESTORE_HANDLE_WRITE_FAILURES_COLLECTION}@BACKFILL_TIMEOUT_MS=${BACKFILL_TIMEOUT_MS}@BACKFILL_MAX_PAGES=${BACKFILL_MAX_PAGES}@BACKFILL_PAGE_LIMIT=${BACKFILL_PAGE_LIMIT}@BACKFILL_MAX_PAGE_LIMIT=${BACKFILL_MAX_PAGE_LIMIT}@BACKFILL_SINCE=${BACKFILL_SINCE}@BACKFILL_STATE_PREFIX=${BACKFILL_STATE_PREFIX}@MAX_PENDING_CLAIMS=${MAX_PENDING_CLAIMS}@MAX_INACTIVE_VERIFIED_CLAIMS=${MAX_INACTIVE_VERIFIED_CLAIMS}@MAX_REJECTION_TOMBSTONES=${MAX_REJECTION_TOMBSTONES}@X_MENTION_CHECK_TIMEOUT_MS=${X_MENTION_CHECK_TIMEOUT_MS}"
if [ -n "${RELAYS:-}" ]; then
