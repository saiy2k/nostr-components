...
(() => {
  ...
  var _0n, _1n, _2n, u8a2, hexes, bitSet, bitMask, u8n, u8fr, validatorFns;
  ...
  var secp256k1P, secp256k1N, _1n5, _2n4, divNearest, Fp, secp256k1, _0n5, fe, ge, TAGGED_HASH_PREFIXES, pointToBytes, numTo32b, modP, modN, Point, GmulAdd, schnorr;
  ...
  var u8a3, createView2, rotr2, isLE2, hexes2, Hash2;
  var init_utils3 = __esm({
    "node_modules/nostr-tools/node_modules/@noble/hashes/esm/utils.js"() {
      init_crypto2();
      u8a3 = (a) => a instanceof Uint8Array;
  ...
  var Chi2, Maj2, SHA256_K2, IV2, SHA256_W2, SHA2562, SHA224, sha2562, sha224;
  var init_sha2562 = __esm({
    "node_modules/nostr-tools/node_modules/@noble/hashes/esm/sha256.js"() {
      ...
      sha2562 = wrapConstructor2(() => new SHA2562());
  ...
  var init_esm = __esm({
    "node_modules/@scure/base/lib/esm/index.js"() {
      ...
      base64 = chain(radix2(6), alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), padding(6), join(""));
      base64url = chain(radix2(6), alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), padding(6), join(""));
      ...
      hex = chain(radix2(4), alphabet("0123456789abcdef"), join(""), normalize((s) => {
      ...
      coderTypeError = `Invalid encoding type. Available types: ${Object.keys(CODERS).join(", ")}`;
    }
  });
  ...
  var u8, u32, createView3, isLE3, wrapCipher;
  var init_utils4 = __esm({
    "node_modules/@noble/ciphers/esm/utils.js"() {
      init_assert3();
      u8 = (arr) => new Uint8Array(arr.buffer, arr.byteOffset, arr.byteLength);
      u32 = (arr) => new Uint32Array(arr.buffer, arr.byteOffset, Math.floor(arr.byteLength / 4));
      createView3 = (arr) => new DataView(arr.buffer, arr.byteOffset, arr.byteLength);
  ...
  var BLOCK_SIZE2, BLOCK_SIZE32, EMPTY_BLOCK, POLY2, sbox, invSbox, rotr32_8, rotl32_8, tableEncoding, tableDecoding, xPowers, ctr, ecb, cbc, cfb, gcm, limit, siv;
  var init_aes = __esm({
    "node_modules/@noble/ciphers/esm/aes.js"() {
      init_utils4();
      init_polyval();
  ...
  var init_poly1305 = __esm({
    "node_modules/@noble/ciphers/esm/_poly1305.js"() {
      ...
      poly1305 = wrapConstructorWithKey2((key) => new Poly1305(key));
    }
  });
  ...
  var _utf8ToBytes, sigma16, sigma32, sigma16_32, sigma32_32, sigma, BLOCK_LEN, BLOCK_LEN32, MAX_COUNTER, U32_EMPTY;
  var init_arx = __esm({
    "node_modules/@noble/ciphers/esm/_arx.js"() {
      init_assert3();
      init_utils4();
  ...
  var chacha20, xchacha20, ZEROS162, updatePadded, ZEROS322, _poly1305_aead, chacha20poly1305, xchacha20poly1305;
  ...
  function encodeTLV(tlv) {
    ...
    return concatBytes3(...entries2);
  }
  function encrypt2(secretKey, pubkey, text2) {
  ...
  function createWrap(seal2, recipientPublicKey) {
    const randomKey = generateSecretKey();
    return finalizeEvent(
      {
        kind: GiftWrap,
        content: nip44Encrypt(seal2, randomKey, recipientPublicKey),
        created_at: randomNow(),
  ...
  function wrapEvent(event, senderPrivateKey, recipientPublicKey) {
    ...
    const seal2 = createSeal(rumor, senderPrivateKey, recipientPublicKey);
    return createWrap(seal2, recipientPublicKey);
  }
  ...
  var __defProp2, __export2, verifiedSymbol, isRecord, utils_exports2, utf8Decoder, utf8Encoder, QueueNode, Queue, JS, i, generateSecretKey, getPublicKey, finalizeEvent, verifyEvent, kinds_exports, isParameterizedReplaceableKind, Metadata, ShortTextNote, RecommendRelay, Contacts, EncryptedDirectMessage, EventDeletion, Repost, Reaction, BadgeAward, Seal, PrivateDirectMessage, GenericRepost, ChannelCreation, ChannelMetadata, ChannelMessage, ChannelHideMessage, ChannelMuteUser, OpenTimestamps, GiftWrap, FileMetadata, LiveChatMessage, ProblemTracker, Report, Reporting, Label, CommunityPostApproval, JobRequest, JobResult, JobFeedback, ZapGoal, ZapRequest, Zap, Highlights, Mutelist, Pinlist, RelayList, BookmarkList, CommunitiesList, PublicChatsList, BlockedRelaysList, SearchRelaysList, InterestsList, UserEmojiList, DirectMessageRelaysList, FileServerPreference, NWCWalletInfo, LightningPubRPC, ClientAuth, NWCWalletRequest, NWCWalletResponse, NostrConnect, HTTPAuth, Followsets, Genericlists, Relaysets, Bookmarksets, Curationsets, ProfileBadges, BadgeDefinition, Interestsets, CreateOrUpdateStall, CreateOrUpdateProduct, LongFormArticle, DraftLong, Emojisets, Application, LiveEvent, UserStatuses, ClassifiedListing, DraftClassifiedListing, Date2, Time, Calendar, CalendarEventRSVP, Handlerrecommendation, Handlerinformation, CommunityDefinition, fakejson_exports, nip42_exports, alwaysTrue, AbstractRelay, Subscription, _WebSocket, AbstractSimplePool, _WebSocket2, SimplePool, nip19_exports, NostrTypeGuard, Bech32MaxSize, BECH32_REGEX, nip04_exports, nip05_exports, NIP05_REGEX, isNip05, _fetch, nip10_exports, nip11_exports, _fetch2, nip13_exports, nip17_exports, nip59_exports, nip44_exports, minPlaintextSize, maxPlaintextSize, v2, TWO_DAYS, now, randomNow, nip44ConversationKey, nip44Encrypt, nip44Decrypt, unwrapEvent2, unwrapManyEvents2, nip18_exports, nip21_exports, NOSTR_URI_REGEX, nip25_exports, nip27_exports, noCharacter, noURLCharacter, nip28_exports, channelCreateEvent, channelMetadataEvent, channelMessageEvent, channelHideMessageEvent, channelMuteUserEvent, nip30_exports, EMOJI_SHORTCODE_REGEX, regex, nip39_exports, _fetch3, nip47_exports, nip54_exports, nip57_exports, _fetch4, nip98_exports, _authorizationScheme;
  var init_esm2 = __esm({
    "node_modules/nostr-tools/lib/esm/index.js"() {
      init_secp256k1();
      init_utils3();
      ...
      isParameterizedReplaceableKind = isAddressableKind;
      Metadata = 0;
      ShortTextNote = 1;
      RecommendRelay = 2;
      Contacts = 3;
      ...
      Bech32MaxSize = 5e3;
      BECH32_REGEX = /[\x21-\x7E]{1,83}1[023456789acdefghjklmnpqrstuvwxyz]{6,}/;
      nip04_exports = {};
      ...
      NIP05_REGEX = /^(?:([\w.+-]+)@)?([\w_-]+(\.[\w_-]+)+)$/;
      isNip05 = (value) => NIP05_REGEX.test(value || "");
      try {
        _fetch = fetch;
      } catch (_) {
        null;
      ...
      nip44Encrypt = (data, privateKey, publicKey) => encrypt22(JSON.stringify(data), nip44ConversationKey(privateKey, publicKey));
      nip44Decrypt = (data, privateKey) => JSON.parse(decrypt22(data.content, nip44ConversationKey(privateKey, data.pubkey)));
      unwrapEvent2 = unwrapEvent;
      unwrapManyEvents2 = unwrapManyEvents;
      nip18_exports = {};
      ...
      channelCreateEvent = (t, privateKey) => {
        let content;
      ...
      EMOJI_SHORTCODE_REGEX = /:(\w+):/;
      regex = () => new RegExp(`\\B${EMOJI_SHORTCODE_REGEX.source}\\B`, "g");
      nip39_exports = {};
  ...
  var SHA256_K3, SHA256_IV, SHA256_W3, SHA2563, sha2563;
  var init_sha2563 = __esm({
    "node_modules/@noble/hashes/esm/sha256.js"() {
      ...
      sha2563 = /* @__PURE__ */ wrapConstructor3(() => new SHA2563());
    }
  });
  ...
  var init_hmac3 = __esm({
    "node_modules/@noble/hashes/esm/hmac.js"() {
      ...
      hmac3 = (hash3, key, message) => new HMAC3(hash3, key).update(message).digest();
  ...
  var _0n6, _1n6, _2n5, hexes4, asciis2, isPosBig, bitMask2, u8n2, u8fr2, validatorFns2, notImplemented;
  ...
  var _0n7, _1n7, _2n6, _3n3, _4n3, _5n2, _8n2, _9n2, _16n2, FIELD_FIELDS2;
  ...
  var _0n8, _1n8, pointPrecomputes, pointWindowSizes;
  ...
  var b2n2, h2b2, DERErr2, DER2, _0n9, _1n9, _2n7, _3n4, _4n4;
  var init_weierstrass2 = __esm({
    "node_modules/@noble/curves/esm/abstract/weierstrass.js"() {
      ...
      init_utils6();
      init_utils6();
      ({ bytesToNumberBE: b2n2, hexToBytes: h2b2 } = utils_exports3);
  ...
  var secp256k1P2, secp256k1N2, _1n10, _2n8, divNearest2, Fpk1, secp256k12, _0n10, TAGGED_HASH_PREFIXES2, pointToBytes2, numTo32b2, modP2, modN2, Point2, GmulAdd2, num, schnorr2;
  var init_secp256k12 = __esm({
    "node_modules/@noble/curves/esm/secp256k1.js"() {
      ...
      pointToBytes2 = (point) => point.toRawBytes(true).slice(1);
      numTo32b2 = (n) => numberToBytesBE2(n, 32);
      modP2 = (x) => mod2(x, secp256k1P2);
      modN2 = (x) => mod2(x, secp256k1N2);
      Point2 = secp256k12.ProjectivePoint;
      GmulAdd2 = (Q, a, b) => Point2.BASE.multiplyAndAddUnsafe(Q, a, b);
    ...
    "node_modules/typescript-lru-cache/dist/LRUCacheNode.js"(exports2) {
      ...
      var LRUCacheNode = class {
        constructor(key, value, options) {
          ...
          this.clone = clone2 !== null && clone2 !== void 0 ? clone2 : false;
    ...
    "node_modules/typescript-lru-cache/dist/LRUCache.js"(exports2) {
      ...
      var LRUCache3 = class {
        ...
        constructor(options) {
          ...
          this.head = null;
          this.tail = null;
          const { maxSize = 25, entryExpirationTimeInMS = null, onEntryEvicted, onEntryMarkedAsMostRecentlyUsed, cloneFn, clone: clone2 } = options !== null && options !== void 0 ? options : {};
  ...
  var init_dist = __esm({
    "node_modules/@nostr-dev-kit/ndk/dist/index.mjs"() {
      ...
      supportedProtocols = /* @__PURE__ */ new Set(["https:", "http:", "file:"]);
      ...
      FLAPPING_THRESHOLD_MS = 1e3;
      NDKRelayConnectivity = class {
        ndkRelay;
        ws;
        _status;
        timeoutMs;
      ...
      NDKRelayStatus = /* @__PURE__ */ ((NDKRelayStatus2) => {
      ...
      NDKRelaySet = class _NDKRelaySet {
        relays;
        debug;
        ndk;
        pool;
      ...
      d = (0, import_debug.default)("ndk:outbox:calculate");
      hashtagRegex = /(?<=\s|^)(#[^\s!@#$%^&*()=+./,[{\]};:'"?><]+)/g;
      nip22RootTags = /* @__PURE__ */ new Set(["A", "E", "I"]);
      nip22ReplyTags = /* @__PURE__ */ new Set(["a", "e", "i"]);
      DEFAULT_RELAY_COUNT = 2;
      processingQueue = {};
      PUBKEY_REGEX = /^[a-f0-9]{64}$/;
      verifiedSignatures = new import_typescript_lru_cache.LRUCache({
        maxSize: 1e3,
        entryExpirationTimeInMS: 6e4
      });
      skipClientTagOnKinds = /* @__PURE__ */ new Set([
        0,
        4,
        1059,
        13,
      ...
      NDKCashuMintList = class _NDKCashuMintList extends NDKEvent {
        static kind = 10019;
        static kinds = [
          10019
          /* CashuMintList */
      ...
      NDKArticle = class _NDKArticle extends NDKEvent {
        static kind = 30023;
        static kinds = [
          30023
          /* Article */
      ...
      NDKCashuToken = class _NDKCashuToken extends NDKEvent {
        _proofs = [];
        _mint;
        static kind = 7375;
        static kinds = [
      ...
      NDKHighlight = class _NDKHighlight extends NDKEvent {
        _article;
        static kind = 9802;
        static kinds = [
          9802
      ...
      NDKImage = class _NDKImage extends NDKEvent {
        static kind = 20;
        static kinds = [
          20
          /* Image */
      ...
      NDKList = class _NDKList extends NDKEvent {
        _encryptedTags;
        static kinds = [
          10063,
          30001,
      ...
      NDKNutzap = class _NDKNutzap extends NDKEvent {
        debug;
        _proofs = [];
        static kind = 9321;
      ...
      NDKSimpleGroupMemberList = class _NDKSimpleGroupMemberList extends NDKEvent {
        relaySet;
      ...
      NDKSimpleGroupMetadata = class _NDKSimpleGroupMetadata extends NDKEvent {
        static kind = 39e3;
        static kinds = [
          39e3
          /* GroupMetadata */
      ...
      NDKStorySticker = class _NDKStorySticker {
        static Text = "text";
      ...
      NDKStory = class _NDKStory extends NDKEvent {
        static kind = 23;
        static kinds = [
          23
          /* Story */
      ...
      coordinates = (position) => `${position.x},${position.y}`;
      dimension = (dimension2) => `${dimension2.width}x${dimension2.height}`;
      ...
      NDKSubscriptionTier = class _NDKSubscriptionTier extends NDKArticle {
        static kind = 37001;
        static kinds = [
          37001
          /* SubscriptionTier */
      ...
      NDKVideo = class _NDKVideo extends NDKEvent {
        static kind = 21;
        static kinds = [
          34235,
          34236,
      ...
      NDKWiki = class extends NDKArticle {
        static kind = 30818;
        static kinds = [
          30818
          /* Wiki */
      ...
      NIP33_A_REGEX = /^(\d+):([0-9A-Fa-f]+)(?::(.*))?$/;
      BECH32_REGEX2 = /^n(event|ote|profile|pub|addr)1[\d\w]+$/;
      defaultOpts = {
        closeOnEose: false,
      ...
      kindIsEphemeral = (kind) => kind >= 2e4 && kind < 3e4;
      NIP05_REGEX2 = /^(?:([\w.+-]+)@)?([\w.-]+)$/;
      NDKUser = class _NDKUser {
        ndk;
        profile;
        profileEvent;
        _npub;
      ...
      READ_MARKER = "read";
      WRITE_MARKER = "write";
      NDKRelayList = class _NDKRelayList extends NDKEvent {
        constructor(ndk, rawEvent) {
          super(ndk, rawEvent);
          this.kind ??= 10002;
        }
      ...
      NDKPrivateKeySigner = class _NDKPrivateKeySigner {
        _user;
        _privateKey;
        _pubkey;
        /**
      ...
      NDKNip07Signer = class _NDKNip07Signer {
        _userPromise;
        encryptionQueue = [];
      ...
      debug6 = (0, import_debug9.default)("ndk:active-user");
      Queue2 = class {
        queue = [];
        maxConcurrency;
      ...
      NDK = class extends import_tseep7.EventEmitter {
        ...
        constructor(opts = {}) {
          super();
          this.debug = opts.debug || (0, import_debug8.default)("ndk");
      ...
      d2 = (0, import_debug11.default)("ndk:zapper:ln");
      d3 = (0, import_debug10.default)("ndk:zapper");
    }
  });
  ...
  var init_constants = __esm({
    "src/common/constants.ts"() {
      ...
      DEFAULT_PROFILE_IMAGE = "./assets/default_dp.png";
    }
  });
  ...
  var init_nostr_login_service = __esm({
    "src/common/nostr-login-service.ts"() {
      ...
      PUBLIC_KEY_PATTERN = /^[0-9a-f]{64}$/i;
      isInitialized = false;
      initPromise = null;
      publicKeyPromise = null;
      inMemoryPublicKey = null;
  ...
  function lnurlFromProfileContent(content) {
    try {
  ...
  var zap_utils_exports = {};
  __export(zap_utils_exports, {
  ...
  async function resolveNip05(nip05Identifier) {
    try {
      const profile = await nip05_exports.queryProfile(nip05Identifier);
  ...
  var init_zap_utils = __esm({
    "src/nostr-zap-button/zap-utils.ts"() {
      ...
      getZapEndpoint2 = async (profileMetadata) => {
      ...
      makeZapEvent = async ({
        ...
        if (!anon) {
          try {
            await ensureInitialized();
            isNostrLoginAvailable = typeof window !== "undefined" && !!window.nostr;
          } catch {
  ...
  // src/base/dialog-component/style.ts
  var getDialogComponentStyles;
  var init_style = __esm({
    "src/base/dialog-component/style.ts"() {
      "use strict";
      getDialogComponentStyles = () => {
        return `
    .nostr-base-dialog {
      width: 400px;
      max-width: 90vw;
  ...
  // src/base/dialog-component/dialog-component.ts
  var dialog_component_exports = {};
  __export(dialog_component_exports, {
    DialogComponent: () => DialogComponent
  });
  var DialogComponent;
  var init_dialog_component = __esm({
    "src/base/dialog-component/dialog-component.ts"() {
      "use strict";
      init_style();
      DialogComponent = class extends HTMLElement {
        dialog = null;
        _titleId = `nostr-dialog-title-${Math.random().toString(36).slice(2, 9)}`;
        _focusTrapHandler = null;
        _outsidePointerHandler = null;
  ...
  // src/nostr-like-button/dialog-likers-style.ts
  function getLikersDialogStyles(theme = "light") {
  ...
  var init_dialog_likers_style = __esm({
    "src/nostr-like-button/dialog-likers-style.ts"() {
      "use strict";
    }
  });
  ...
  // src/nostr-like-button/dialog-likers.ts
  var dialog_likers_exports = {};
  __export(dialog_likers_exports, {
    injectLikersDialogStyles: () => injectLikersDialogStyles,
    openLikersDialog: () => openLikersDialog
  });
  function renderLikeEntry(like, index) {
    ...
    const profilePicture = profilePictureSafe ? `<img src="${profilePictureSafe}" alt="${authorNameSafe}" class="like-author-picture" />` : `<div class="like-author-picture-default">\u{1F464}</div>`;
    const isDislike = like.content === "-";
    const statusText = isDislike ? "Disliked" : "Liked";
    const statusClass = isDislike ? "disliked" : "liked";
    const authorNameHtml = njumpUrl ? `<a href="${njumpUrl}" target="_blank" rel="noopener noreferrer" class="like-author-link">
            ${authorNameSafe}
          </a>` : `<span class="like-author-link">${authorNameSafe}</span>`;
    return `
    <div class="like-entry" data-like-index="${index}" data-author-pubkey="${authorPubkeySafe}">
      <div class="like-author-info">
        ...
        <div class="like-author-details">
          ${authorNameHtml}
          <div class="like-date">
            ${formatRelativeTime(Math.floor(like.date.getTime() / 1e3))}
  ...
  function renderSkeletonLikeEntry(like, npub2, index) {
    const isDislike = like.content === "-";
    const statusText = isDislike ? "Disliked" : "Liked";
    const statusClass = isDislike ? "disliked" : "liked";
    return `
  ...
  async function openLikersDialog(params) {
  ...
  async function renderInitialContent(likeDetails) {
    ...
    const skeletonEntries = likeDetails.map((like, index) => renderSkeletonLikeEntry(like, npubs[index], index)).join("");
    return `
    <div class="likers-dialog-content">
      <div class="likers-list">
        ${skeletonEntries}
  ...
  async function enhanceLikeDetailsProgressively(dialog, likeDetails, relays) {
    const likersList = dialog.querySelector(".likers-list");
    ...
    try {
      ...
      for (let index = 0; index < likeDetails.length; index++) {
        ...
        const npub2 = npubMap.get(like.authorPubkey) || like.authorPubkey;
        let enhanced;
        if (profile) {
  ...
  async function enhanceLikeDetailsIndividually(dialog, likeDetails, relays) {
    const likersList = dialog.querySelector(".likers-list");
    if (!likersList) return;
    const profileCache2 = /* @__PURE__ */ new Map();
    const profilePromises = likeDetails.map(async (like, index) => {
      if (profileCache2.has(like.authorPubkey)) {
        const cachedProfile = profileCache2.get(like.authorPubkey);
        return {
          index,
          enhanced: {
            ...like,
      ...
      try {
        ...
        const npub2 = hexToNpub(like.authorPubkey);
        const enhanced = {
          ...like,
          authorName: profileContent.display_name || profileContent.name || npub2,
          authorPicture: profileContent.picture,
        ...
        profileCache2.set(like.authorPubkey, enhanced);
        return {
          index,
          enhanced
        };
  ...
  var injectLikersDialogStyles;
  var init_dialog_likers = __esm({
    "src/nostr-like-button/dialog-likers.ts"() {
      "use strict";
  ...
  var NostrService = class _NostrService {
    ...
    static getInstance() {
      if (!_NostrService.instance) {
        _NostrService.instance = new _NostrService();
      }
      return _NostrService.instance;
    }
    async connectToNostr(relays = [...DEFAULT_RELAYS]) {
      if (this.isConnected) {
     ...
     */
    addNewRelays(relays) {
      const knownRelays = new Set(this.getRelays().map((r) => normalizeURL2(r)));
      for (const url of relays) {
        const normalized = normalizeURL2(url);
        ...
        if (this.ndk.pool && this.ndk.pool.relays) {
          for (const [url, relay] of this.ndk.pool.relays.entries()) {
            if (relay && relay.status >= NDKRelayStatus.CONNECTED) {
              connected.push(normalizeURL2(url));
            }
          }
        } else {
    ...
    async resolveNDKEvent(identifier) {
      if (identifier.hex) {
...
${url}`;
    ...
    async fetchFollows(user) {
      try {
        const follows2 = await user.followSet();
        const count = follows2.size;
        return count;
      } catch (error) {
        return 0;
      }
    ...
    async fetchNotesAndReplies(user) {
      try {
        const events = await this.ndk.fetchEvents({
          kinds: [NDKKind.Text],
          authors: [user.pubkey],
  ...
  var NCStatus = /* @__PURE__ */ ((NCStatus2) => {
    ...
    NCStatus2[NCStatus2["Ready"] = 2] = "Ready";
    NCStatus2[NCStatus2["Error"] = 3] = "Error";
    return NCStatus2;
  })(NCStatus || {});
  var EVT_STATUS = "nc:status";
  var NostrBaseComponent = class extends HTMLElement {
    ...
    disconnectedCallback() {
      ...
      if (this.shadowRoot && this._delegated) {
    ...
    /** Status map API */
    setStatusFor(key, next, error) {
      const prev = this._statuses.get(key);
      const changed = prev !== next || next === 3 /* Error */ && !!error;
      if (!changed) return;
      this._statuses.set(key, next);
      if (next === 3 /* Error */ && error) {
        this.errorMessage = error;
      } else if (prev === 3 /* Error */ && next !== 3 /* Error */) {
        this.errorMessage = "";
      }
    ...
    getStatusFor(key) {
      return this._statuses.get(key) ?? 0 /* Idle */;
    }
    snapshotStatuses() {
    ...
    onStatusChange(_overall) {
    }
    /** Hook for subclasses to react when relays are connected */
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    onNostrRelaysConnected() {
    }
    computeOverall() {
      const vals = [...this._statuses.values()];
      if (vals.includes(3 /* Error */)) return 3 /* Error */;
      if (vals.includes(1 /* Loading */)) return 1 /* Loading */;
      if (vals.includes(2 /* Ready */)) return 2 /* Ready */;
      return 0 /* Idle */;
    }
    /**
     ...
     */
    initChannelStatus(key, status, opts = { reflectOverall: false }) {
    ...
    channel(key) {
      return {
        set: (s, e) => this.setStatusFor(key, s, e),
    ...
    validateInputs() {
      ...
      if (!(theme === "light" || theme === "dark")) {
        this.conn.set(3 /* Error */, `Invalid theme '${theme}'. Accepted values are 'light', 'dark'`);
        console.error(`Nostr-Components: ${tagName}: ${this.errorMessage}`);
        return false;
      } else if (relays && typeof relays != "string") {
        this.conn.set(3 /* Error */, `Invalid relays list`);
        console.error(`Nostr-Components: ${tagName}: ${this.errorMessage}`);
        return false;
      } else if (relays) {
        ...
        if (invalidRelays.length > 0) {
          ...
          this.conn.set(3 /* Error */, `Invalid relay URLs: ${invalidRelaysList}. Relay URLs must start with 'wss://' or 'ws://'`);
          console.error(`Nostr-Components: ${tagName}: ${this.errorMessage}`);
          return false;
        }
      }
    ...
    async connectToNostr() {
      ...
      try {
        ...
        this.conn.set(3 /* Error */, "Failed to connect to relays");
        this.nostrReadyReject?.(error);
      }
    }
    ensureNostrConnected() {
    ...
    */
    delegateEvent(type, selector, handler) {
      ...
      if (this._delegated?.has(key)) return;
      if (!this._delegated) this._delegated = /* @__PURE__ */ new Set();
      this._delegated.add(key);
    ...
    addDelegatedListener(type, selector, handler) {
     ...
     */
    updateHostClasses() {
      const isLoading = this.computeOverall() === 1 /* Loading */;
      const isError = this.computeOverall() === 3 /* Error */;
      const isReady = this.computeOverall() === 2 /* Ready */;
     ...
     */
    handleNjumpClick(eventType, detail, njumpPath) {
      if (this.computeOverall() !== 2 /* Ready */) return;
    ...
    /** Private methods */
    resetNostrReadyBarrier() {
      this.connectSeq++;
      this.nostrReady = new Promise((resolve, reject) => {
  ...
  function shouldDisableLikeButton({
    ...
    return actionLoading || !compact && connectionLoading;
  }
  ...
  function renderErrorContainer(leftContent, rightContent) {
    return `
  ...
  function getComponentStyles(customStyles) {
    return `
    <style>
      ${getBaseStyles()}
  ...
  // src/nostr-like-button/dialog-help-style.ts
  ...
  var showHelpDialog = async (theme) => {
  ...
  function isUnlikeContent(content) {
    return content === "-";
  }
  function netLikesByPubkey(events) {
  ...
  // src/common/auth-onboarding-style.ts
  function getAuthOnboardingDialogStyles() {
    return `
    .auth-onboarding {
      display: grid;
      gap: 14px;
  ...
  var ACTION_CONTENT = {
    like: {
      ...
      description: "Connect a Nostr signer once to like this page and carry your reactions with you across the web.",
      whyItMatters: "Nostr gives regular websites a shared social layer, and creators can add zap buttons to receive sats directly."
    },
    zap: {
      eyebrow: "Instant Lightning tips",
      title: "Send sats in a couple of clicks",
      description: "Connect a Nostr signer once to send a zap. Zaps are instant Bitcoin Lightning tips that go straight to creators.",
      whyItMatters: "This same setup lets creators add zap buttons to their own sites and receive sats without a platform in the middle."
    },
    follow: {
      eyebrow: "Portable audience graph",
      title: "Follow creators without platform lock-in",
      description: "Connect a Nostr signer once to follow this creator and keep that relationship in your own account, not inside one app.",
      whyItMatters: "Creators can own their audience and add sats-enabled actions on regular websites instead of depending on one platform."
    }
  };
  var activeOnboardingPromise = null;
  function injectAuthOnboardingStyles() {
  ...
  function getAuthOnboardingContent(action) {
    return ACTION_CONTENT[action];
  }
  function getAuthOnboardingLinks() {
    return {
      quickSetupUrl: QUICK_SETUP_URL,
      signerInstallUrl: SIGNER_INSTALL_URL
    };
  }
  function getSignerUnavailableMessage(action) {
    switch (action) {
      case "like":
  ...
  function normalizeOnboardingTheme(theme) {
    return theme === "dark" ? "dark" : "light";
  }
  function createEnsureSignerForAction(dependencies = {
    ensureInitialized,
    getPublicKey: getPublicKey2,
    hasConnectedSigner,
    showAuthOnboarding
  }) {
    return async function ensureSignerForAction2(options) {
      const unavailable = () => ({
        status: "unavailable",
        publicKey: null,
  ...
  var ensureSignerForAction = createEnsureSignerForAction();
  async function showAuthOnboarding(options) {
    if (activeOnboardingPromise) {
      return activeOnboardingPromise;
    }
    activeOnboardingPromise = (async () => {
      injectAuthOnboardingStyles();
      await Promise.resolve().then(() => (init_dialog_component(), dialog_component_exports));
      await customElements.whenDefined("dialog-component");
    ...
    `;
      ...
      const guideButton = dialog.querySelector(
        ".auth-onboarding-secondary"
      );
      const dismissButton = dialog.querySelector(
        ".auth-onboarding-dismiss"
      );
      const statusNode = dialog.querySelector(
        ".auth-onboarding-status"
      );
  ...
  function applyOptimisticUnlike(state) {
    return {
      isLiked: false,
      likeCount: clampLikeCount(state.likeCount - 1)
    };
  }
  function rollbackOptimisticLikeState({
    current,
    snapshot,
  ...
  var NostrLike = class extends NostrBaseComponent {
    ...
    validateInputs() {
      if (!super.validateInputs()) {
        this.likeActionStatus.set(0 /* Idle */);
      ...
      if (errorMessage) {
        ...
        this.likeListStatus.set(3 /* Error */, errorMessage);
    ...
    async updateLikeCount() {
      ...
      try {
        ...
        this.likeListStatus.set(3 /* Error */, "Failed to load likes");
      } finally {
        if (seq === this.loadSeq) {
          this.render();
        }
    ...
    handleLikeMutationFailure(error, snapshot, didApplyOptimisticUpdate, fallbackMessage) {
    ...
    async handleLikeClick() {
      ...
      if (!targetUrl) {
        this.likeActionStatus.set(3 /* Error */, "Invalid URL");
        this.render();
        return;
      }
    ...
    async handleLike(targetUrl) {
      ...
      try {
        ...
        const signedEvent = await signEvent3(event);
        rollbackSnapshot = {
          isLiked: this.isLiked,
          likeCount: this.likeCount
        };
    ...
    async handleCountClick() {
      ...
      try {
        const { openLikersDialog: openLikersDialog2 } = await Promise.resolve().then(() => (init_dialog_likers(), dialog_likers_exports));
        await openLikersDialog2({
    ...
    renderContent() {
      ...
      const isLoading = shouldDisableLikeButton({
        compact,
        actionLoading: this.likeActionStatus.get() === 1 /* Loading */,
        connectionLoading: this.conn.get() === 1 /* Loading */
      });
      const isCountLoading = this.likeListStatus.get() === 1 /* Loading */;
      const isError = this.computeOverall() === 3 /* Error */;
