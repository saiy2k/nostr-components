...
<a href="https://github.com/saiy2k/nostr-components" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', padding: '7px 18px', background: '#333', color: '#fff', fontWeight: 600, fontSize: '13px', borderRadius: '6px', textDecoration: 'none', boxShadow: '0 1px 3px rgba(0,0,0,0.12)' }}>View Github Repository</a>
<a href="https://geyser.fund/project/nostrcomponents" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', padding: '7px 18px', background: '#cb8a20', color: '#fff', fontWeight: 600, fontSize: '13px', borderRadius: '6px', textDecoration: 'none', boxShadow: '0 1px 3px rgba(0,0,0,0.12)' }}>⚡ Support this project on Geyser Fund</a>
</div>
...
<nostr-zap-button url="https://nostr-components.web.app/" nip05="saiy2k@iris.to"></nostr-zap-button>
