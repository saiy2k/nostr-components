import{m as v,e as s,g as m,a as d,p as b}from"../assets/base-styles-BNQtJP9X.js";import{N as y}from"../assets/nostr-user-component-BnJsHUrA.js";import{h as w}from"../assets/nostr-service-pr_crY62.js";import{r as x,a as C,b as E,c as N}from"../assets/copy-delegation-Dhb67t6F.js";import"../assets/user-resolver-Bo16ugek.js";function A({isLoading:n,isError:r,errorMessage:o,userProfile:e,ndkUser:t,showNpub:a,showFollow:c}){if(n)return L();if(r||e==null)return S(o||"");const i=e.displayName||e.name||v((t==null?void 0:t.npub)||""),p=s(i),f=s(e.picture||w),g=(t==null?void 0:t.npub)||"",h=(e==null?void 0:e.nip05)||"",u=s((t==null?void 0:t.pubkey)||"");return l(`<img src='${f}' alt='Nostr profile image of ${p}' loading="lazy" decoding="async"/>`,`${x({name:i})}
     ${e.nip05?C(h):""}
     ${a===!0?E(g||""):""}
